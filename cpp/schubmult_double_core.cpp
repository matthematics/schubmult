...
//
// Build:  make schubmult_double_core     (needs SymEngine C++ headers/lib, e.g. from conda)
// Usage:  ./schubmult_double_core 3 1 2 - 2 1 3
//         ./schubmult_double_core --same 3 1 2 - 2 1 3      (z = y, as schubmult_double --same)
//         ./schubmult_double_core --code 2 0 - 1 0
...
int main(int argc, char** argv) {
    CliArgs args = parse_cli(argc, argv, "schubmult_double_core", " [--same]");
    bool same = false;
