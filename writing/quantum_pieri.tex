...
\end{align*}
Not only does the product $\qsch_{2413}^{P}(x;y)\qsch_{3412}^{P}(x;y)$ include extra terms indexed by permutations in $W^P$, there are also terms with nonzero coefficients that are in $W^{P^+}\setminus W^P$:
\begin{align*}
...
&+ \color{red}{q_1(\alpha_1+\alpha_2)\,\qsch_{13254}^{P^+}(x;y)} \\
&+ \color{red}{q_1\,\qsch_{14253}^{P^+}(x;y)} \\
