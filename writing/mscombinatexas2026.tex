...
\title[A Bialgebra Framework for Schubert Calculus]{A Bialgebra Framework for Positivity in Schubert Calculus}
...
\begin{itemize}
  \item Basis of the polynomial ring $\mathbb{Z}[x_1,x_2,\ldots]$, sharing their structure constants with the Schubert classes in the cohomology of the complete flag variety.
...
We define the dual algebra $\dcoma$ to be the graded dual of $\coma$. For the monomial basis, which is indexed by weak compositions, we define the dual basis $[a]$ for weak compositions $a$ by 
$$\langle x_a, [b]\rangle = \delta_{a,b}$$

We have that the dual product is concatenation:
\[
\wb{a}\cdot \wb{b} = \wb{a\,b}.
\]

Hence $\dcoma$ is a free associative algebra (tensor algebra on the generators $\wb{k}$, $k\ge 0$). The coproduct is
\[\Delta(\wb{c}) = \sum_{a + b=c} \wb{a} \otimes \wb{b}.\]
...
Let $\Xi_w^k$ be the basis of $\dcoma_k$ indexed by permutations $w$ such that $w(p) < w(p+1)$ for all $p>k$ satisfying the following:
\begin{itemize}
\item $\Xi_{w}^1 = [w(1) - 1]$
...
are the elusive Littlewood-Richardson coefficients for Schubert polynomials!
...
Pipe dreams are well-studied objects introduced in the $1990$ by Bergeron and Billey to represent monomials of Schubert polynomials. We associate a fixed bound $\mathrm{length}(R)$ that is $\geq$ the length of the Lehmer code 
\begin{center}
...
\begin{frame}{Transition algorithm on bounded pipe dreams}
  There is an algorithm that takes a bounded pipe dream of length $n$ with row $n$ empty to a unique bounded pipe dream of length $n-1$
by a method that adheres to the Schubert transition formula in a way that preserves important combinatorial invariants and structures
\begin{center}
  {\scriptsize
  \begin{algorithmic}
...
\begin{itemize}
  \item \emph{untransitioning} $R_1$ in all possible valid ways to add as many empty rows as the length of $\mathrm{perm}(R_2)$
  \item shifting $R_2$ downward by $\mathrm{length}(R_1)$
  \item placing the shifted $R_2$ into the new empty region, unchanged, if doing so yields a valid pipe dream (meaning we can connect the pipes consistently)
\end{itemize}
...
\begin{theorem}[S, 2026+]
The product $\star$ is associative and gives a well-defined ring structure on the vector space $\RC$ spanned by bounded pipe dreams, graded by length and degree
\end{theorem}
\end{frame}
...
\end{tikzpicture}
  ...
  \vspace{0.5em}
  \textit{Untransitioning of $R_1$}

  \vspace{0.3em}
  \begin{minipage}[t]{0.18\textwidth}\centering\scriptsize A\\[0.2em]
\begin{tikzpicture}[scale=0.15, baseline=(current bounding box.north)]
  \draw[lightgray, very thin, opacity=0.3] (0,-4) -- (4,-4);
  \draw[lightgray, very thin, opacity=0.3] (0,-4) -- (0,4);
  \draw[lightgray, very thin, opacity=0.3] (0,-3) -- (4,-3);
  \draw[lightgray, very thin, opacity=0.3] (1,-4) -- (1,4);
  \draw[lightgray, very thin, opacity=0.3] (0,-2) -- (4,-2);
  \draw[lightgray, very thin, opacity=0.3] (2,-4) -- (2,4);
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (4,-1);
  \draw[lightgray, very thin, opacity=0.3] (3,-4) -- (3,4);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (4,0);
  \draw[lightgray, very thin, opacity=0.3] (4,-4) -- (4,4);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (4,1);
  \draw[lightgray, very thin, opacity=0.3] (0,2) -- (4,2);
  \draw[lightgray, very thin, opacity=0.3] (0,3) -- (4,3);
  \draw[lightgray, very thin, opacity=0.3] (0,4) -- (4,4);
  ...
  \node[font=\fontsize{3}{3}\selectfont, text=green!60!black, fill=white, inner sep=0pt, circle] at (0.5,1.5) {3};
  \node[font=\fontsize{3}{3}\selectfont, text=green!60!black, fill=white, inner sep=0pt, circle] at (0.5,3.5) {1};
  \draw[black, line width=1.4pt] (0,-4) rectangle (4,4);
\end{tikzpicture}
  \end{minipage}
  \begin{minipage}[t]{0.18\textwidth}\centering\scriptsize B\\[0.2em]
\begin{tikzpicture}[scale=0.15, baseline=(current bounding box.north)]
  \draw[lightgray, very thin, opacity=0.3] (0,-3) -- (5,-3);
  \draw[lightgray, very thin, opacity=0.3] (0,-3) -- (0,5);
  \draw[lightgray, very thin, opacity=0.3] (0,-2) -- (5,-2);
  \draw[lightgray, very thin, opacity=0.3] (1,-3) -- (1,5);
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (5,-1);
  \draw[lightgray, very thin, opacity=0.3] (2,-3) -- (2,5);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (5,0);
  \draw[lightgray, very thin, opacity=0.3] (3,-3) -- (3,5);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (5,1);
  \draw[lightgray, very thin, opacity=0.3] (4,-3) -- (4,5);
  \draw[lightgray, very thin, opacity=0.3] (0,2) -- (5,2);
  \draw[lightgray, very thin, opacity=0.3] (5,-3) -- (5,5);
  \draw[lightgray, very thin, opacity=0.3] (0,3) -- (5,3);
  ...
  \draw[black, line width=1.4pt] (0,-3) rectangle (5,5);
\end{tikzpicture}
  \end{minipage}
  \begin{minipage}[t]{0.18\textwidth}\centering\scriptsize C\\[0.2em]
\begin{tikzpicture}[scale=0.15, baseline=(current bounding box.north)]
  \draw[lightgray, very thin, opacity=0.3] (0,-2) -- (6,-2);
  ...
  \draw[black, line width=1.4pt] (0,-2) rectangle (6,6);
\end{tikzpicture}
  \end{minipage}
  \begin{minipage}[t]{0.18\textwidth}\centering\scriptsize D\\[0.2em]
\begin{tikzpicture}[scale=0.15, baseline=(current bounding box.north)]
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (7,-1);
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (0,7);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (7,0);
  \draw[lightgray, very thin, opacity=0.3] (1,-1) -- (1,7);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (7,1);
  \draw[lightgray, very thin, opacity=0.3] (2,-1) -- (2,7);
  \draw[lightgray, very thin, opacity=0.3] (0,2) -- (7,2);
  \draw[lightgray, very thin, opacity=0.3] (3,-1) -- (3,7);
  \draw[lightgray, very thin, opacity=0.3] (0,3) -- (7,3);
  \draw[lightgray, very thin, opacity=0.3] (4,-1) -- (4,7);
  \draw[lightgray, very thin, opacity=0.3] (0,4) -- (7,4);
  \draw[lightgray, very thin, opacity=0.3] (5,-1) -- (5,7);
  \draw[lightgray, very thin, opacity=0.3] (0,5) -- (7,5);
  \draw[lightgray, very thin, opacity=0.3] (6,-1) -- (6,7);
  \draw[lightgray, very thin, opacity=0.3] (0,6) -- (7,6);
  \draw[lightgray, very thin, opacity=0.3] (7,-1) -- (7,7);
  ...
  \draw[black, line width=1.4pt] (0,-1) rectangle (7,7);
\end{tikzpicture}
  \end{minipage}
  \begin{minipage}[t]{0.18\textwidth}\centering\scriptsize E\\[0.2em]
\begin{tikzpicture}[scale=0.15, baseline=(current bounding box.north)]
...
\begin{tikzpicture}[scale=0.18, baseline=(current bounding box.center)]
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (7,-1);
  \draw[lightgray, very thin, opacity=0.3] (0,-1) -- (0,7);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (7,0);
  \draw[lightgray, very thin, opacity=0.3] (1,-1) -- (1,7);
...
\begin{frame}{A warm-up: dual key polynomials}
  ...
  \begin{itemize}
    \item The \emph{Coxeter-Knuth equivalence}  on reduced words \cite{morse2016crystal} (Morse-Schilling 2016) as well as the $Q$ tableau \cite{hamaker2014relating} (Hamaker-Young 2014) are preserved by $\star$. Using this, we define $R\sim A$ iff $Q(R)=Q(A)$, $\wtt(R)=\wtt(A)$, and $\mathrm{word}(R)$, $\mathrm{word}(A)$ are Coxeter-Knuth equivalent.
    \item Quotient the ring by this equivalence relation to obtain $\Key{}\RC$ with $[R]\mapsto\Key{\mathrm{exwt}(R)}^*$.
  \end{itemize}
  \begin{theorem}[S, 2026+]
    $\pi_{\Key{}}:\Key{}\RC \twoheadrightarrow \dcoma$, $[R]\mapsto\Key{\mathrm{wt}(R)}^*$ is a surjective ring homomorphism. The structure constants $k_{\alpha,\beta}^\gamma$ in $\Key{\alpha}^*\Key{\beta}^* = \sum_\gamma k_{\alpha,\beta}^\gamma\,\Key{\gamma}^*$ count classes $[R_\gamma]$ in $[R_\alpha]\star[R_\beta]$, and in particular are nonnegative.
  \end{theorem}
  \vspace{12pt}
  Other combinatorial interpretations of these coefficients are known.
\end{frame}
...
\begin{frame}{Forest polynomials}
    Nearly the same construction works for the recently discovered \emph{forest polynomials}, whose products expand nonnegatively in $\coma$, unlike key polynomials
\begin{itemize}
\item Forest polynomials (Nadeau and Tewari 2024 \cite{nadeau2024forest}, $+$Spink \cite{nadeau2024quasisym}): $\Forest{F}$ are polynomials indexed by ``indexed forests'' $F$ (bijectively related to weak compositions), which can be characterized by an equivalence relation on words, or quasisymmetric divided difference operators based on the Bergeron-Sottile map \cite{coprod}
...
\item Using the equivalence relation, we can define a ``forest invariant'' $\Omega(R)$ for each pipe dream $R$, and obtain
\end{itemize}
\begin{theorem}[S, 2026+]
...
\end{theorem}
In Guo and Woodruff 2026 \cite{guo2026forest} there is also a pipe dream formula
\end{frame}

% labeled indexed forests?
\begin{frame}{Forest equivalence on $\RC$}
  \begin{itemize}
    \item We can actually do better, algebraically speaking. The equivalence relation is as strong as Edelman-Greene insertion (Edelman-Greene 1987 \cite{edelman1987balanced}) and uniquely encodes a word and compatible sequences as a pair of labeled indexed forests
    
    \item Let $\sim$ be the equivalence relation on $\RC$ such that $R\sim A$ if $\wtt(R)=\wtt(A)$, $\mathrm{code}(\Omega(R))=\mathrm{code}(\Omega(A))$ and $\Omega_Q(R) = \Omega_Q(A)$, where $\Omega_Q$ is the $Q$-tableau of the insertion algorithm. Let $\Omega\RC$ be the set of equivalence classes of $\RC$ under $\sim$.
  \end{itemize}
\begin{center}
\begin{tikzpicture}[scale=0.3,
...
\begin{frame}{Algebra of forest pipe dreams}
    ...
    $$\pi_{\Forest{}}:\Omega\RC\twoheadrightarrow\dcoma$$
    such that
    $$[R]\mapsto \Forest{\mathrm{code}(\Omega(R))}^*$$
    is a surjective homomorphism of rings onto $\dcoma$.
    \end{theorem}
    {\textbf{Note:}} Unlike for key polynomials, this fails without restricting to this particular subalgebra. $\Omega\RC$ is not a quotient of $\RC$ by this equivalence relation.
\end{frame}
...
\begin{frame}{Dual forest polynomial coproduct?}
  ...
  \end{align*}
  \begin{itemize}
  \item It is distinctly possible that a positive coproduct formula for $\Forest{F}^*$ in $\dcoma$ can be obtained by analyzing the $\star$ product of pipe dreams with $\code(\Omega(R)) = F$.
  \end{itemize}
\end{frame}
...
\begin{frame}{Summary}
  \begin{itemize}
    ...
    \item Positive formulas for the forest polynomial coproduct remain open and are potentially accessible via this framework.
  \end{itemize}
  \vspace{0.5em}
  \centering Thank you!
\end{frame}
