...
$$\frac{N(u,\mdom{v})}{N(u,\mdom{v'})}\leq \frac{N(u,\widehat{v})}{N(u,v')}$$
Multiplying both sides of the original inequality by this positive inequality, we obtain
...
% $$N(u,v,w)=\begin{cases}
% 1&\text{ if }c_{u,v'}^w(0;0)\neq 0\text{ for some }v'\leq_L v\\
% 0&\text{ otherwise}.
% \end{cases}$$

\begin{lemma}
$$N(u,v) = \sum_{v'\leq_L v}\bigl|[v',v]_L\bigr|\,N_0(u,v')$$
\end{lemma}
does it miss any?
\begin{corollary}
$$N(u,\mdom{v}) \leq \sum_{v'\leq_L v}\bigl|[v',v]_L\bigr|\,N_0(u,v')$$

\end{corollary}

\begin{corollary}[Output-polynomiality, dominant case]
Let $u,v\in S_n$ and suppose $v$ is dominant. Then there is a polynomial $P(n,N)$ such that the runtime of schubmult is
$$O(E_nP(n,N(u,v)))$$
