...
%% 
\title{A Littlewood--Richardson rule for grove polynomials}
...
Let $F$ be an indexed forest and let $\kappa:\mathrm{IN}(F)\to 2^{\mathbb{N}}$ be a set-valued labeling. Let $P$ be the $P$-forest of the reverse of $\RC^0(F)$. Consider the set 
