...
The main combinatorial theorem of the paper is Theorem \ref{theorem:forestpolyLR}: an \emph{enumerative}, Schubert-calculus-style Littlewood--Richardson rule for the product of two forest polynomials themselves. Concretely, the structure constants $\beta_{ab}^c$ in
