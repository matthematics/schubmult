...
val=sympify("(y_1 - z_4)*((y_1 - z_2)*((y_6 - z_1)*(y_1 - z_1)*((y_6 - z_2)*(y_3 - z_2) + (y_3 + y_6 - z_2 - z_3)*(y_1 - z_3)) + (y_1 + y_6 - z_2 - z_3)*(y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)) - ((y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2)*(y_3 - z_2) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2))) + (y_3 - z_5)*((y_1 - z_2)*((y_6 - z_1)*(y_1 - z_1)*((y_6 - z_2)*(y_3 - z_2) + (y_3 + y_6 - z_2 - z_3)*(y_1 - z_3)) + (y_1 + y_6 - z_2 - z_3)*(y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)) + (y_3 - z_4)*((y_6 - z_1)*(y_1 - z_1)*((y_6 - z_2)*(y_3 - z_2) + (y_3 + y_6 - z_2 - z_3)*(y_1 - z_3)) + (y_1 + y_6 - z_2 - z_3)*(y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*((y_6 - z_2)*(y_2 - z_2) + (y_2 + y_6 - z_2 - z_3)*(y_1 - z_3)) - ((y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2)*(y_3 - z_2) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2))) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_2)*((y_6 - z_2)*(y_2 - z_2) + (y_2 + y_6 - z_2 - z_3)*(y_1 - z_3)) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_2 - z_4)*((y_6 - z_2)*(y_2 - z_2) + (y_2 + y_6 - z_2 - z_3)*(y_1 - z_3)) - (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2)*(y_2 - z_2)")
val2=sympify("(y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2)*(y_2 - z_3)*(y_6 - z_5) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_2)*(y_3 - z_3)*(y_3 - z_4) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_2 - z_4)*(y_2 - z_3)*(y_6 - z_5) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_3 - z_5)*(y_6 - z_4)*(y_6 - z_2) + (y_6 - z_1)*(y_1 - z_1)*(y_6 - z_2)*(y_2 - z_4)*(y_2 - z_3)*(y_3 - z_3) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_2)*(y_6 - z_2)*(y_2 - z_5) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_2)*(y_2 - z_4)*(y_2 - z_3) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_2)*(y_1 - z_5)*(y_2 - z_3) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_3 - z_2)*(y_2 - z_3)*(y_3 - z_4) + (y_6 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_4)*(y_1 - z_2)*(y_6 - z_2) + (y_6 - z_1)*(y_1 - z_1)*(y_6 - z_3)*(y_2 - z_3)*(y_3 - z_4)*(y_6 - z_5) + (y_6 - z_1)*(y_1 - z_1)*(y_6 - z_4)*(y_6 - z_3)*(y_3 - z_2)*(y_3 - z_3) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_2 - z_3)*(y_2 - z_2) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_2 - z_3)*(y_3 - z_4) + (y_6 - z_1)*(y_2 - z_1)*(y_1 - z_1)*(y_6 - z_3)*(y_2 - z_5)*(y_2 - z_3) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_6 - z_3)*(y_2 - z_3) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_2)*(y_1 - z_5)*(y_2 - z_4) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_6 - z_2)*(y_3 - z_2)*(y_3 - z_4) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_6 - z_2)*(y_2 - z_5)*(y_3 - z_2) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_2)*(y_1 - z_5) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_1 - z_4)*(y_3 - z_2) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_3)*(y_3 - z_5)*(y_3 - z_2) + (y_6 - z_1)*(y_3 - z_1)*(y_1 - z_1)*(y_1 - z_4)*(y_1 - z_5)*(y_6 - z_3)")

ring = SingleSchubertRing(z)

S1 = ring(val)
S2 = ring(val2)
SS = (S1 - S2).expand(deep=False)
print(f"{S1=}")
#print(f"S1.items()")

# >>> yz_ring = DoubleSchubertRing(GeneratingSet("z"),GeneratingSet("y"))
# >>> from symengine import sympify
# >>> yz_ring(sympify("(-(y_1 - z_1)*(y_5 - z_1) + (y_5 - z_1)*(y_1 + y_5 - z_1 - z_2))"))
# (-y_1*(-y_2 + y_5) + y_5*(-y_2 + y_5)) + (y_1 - y_5)*DSz((1, 3, 2), y) + DSz((2, 3, 1), y)
# >>> yz_ring.genset
# GeneratingSet('z')
# >>> yz_ring.coeff_genset
# GeneratingSet('y')
# >>> yz_ring.from_sympy(sympify("(-(y_1 - z_1)*(y_5 - z_1) + (y_5 - z_1)*(y_1 + y_5 - z_1 - z_2))"))
# (-y_1*(-y_2 + y_5) + y_5*(-y_2 + y_5)) + (y_1 - y_5)*DSz((1, 3, 2), y) + DSz((2, 3, 1), y)
# >>>
