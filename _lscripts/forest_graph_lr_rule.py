...
def verify_pair(perm1, perm2, n):
    ...
    from schubmult.rings.polynomial_algebra import PolynomialAlgebra, FundamentalSlidePolyBasis, ForestPolyBasis
    ...
    try:
        ...
        prd = ForestPoly(*comp1) * ForestPoly(*comp2)
        forest1 = f.forest_poly(comp1)
        forest2 = f.forest_poly(comp2)
