...
\begin{frame}{Forest invariant algebra}
  \begin{itemize}
    \item We can actually do better, algebraically speaking. The equivalence relation is actually as strong as Edelman-Greene insertion and uniquely encodes a word and compatible sequences as a pair of labeled indexed forests
...
\begin{frame}{Dual forest LR rule}
    \begin{theorem}[S, 2026+]
...
\begin{frame}{Dual forest polynomial LR rule}
  \begin{theorem}[S, 2026+]
    Suppose
