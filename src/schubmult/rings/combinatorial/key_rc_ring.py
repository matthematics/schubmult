...
def _canonical_rc(rc):
    ...
    #     return None
    perm = uncode(rc.extremal_weight)
    the_set = {rc2 for rc2 in RCGraph.all_rc_graphs(perm, len(rc), weight=rc.length_vector) if rc2.weight_tableau == rc.weight_tableau and rc2.extremal_weight == rc.extremal_weight}
