...
\begin{frame}{Plan}
\begin{itemize}
  \item Slightly expand the polynomial ring
...
\begin{frame}{Direct sum of polynomial algebras}
Define
\[
...
are the Littlewood-Richardson coefficients for the complete flag variety on a complex vector space of dimension $n+1$.
...
\begin{frame}{Coproduct on the ring of pipe dreams}
  It is not immediately clear how to lift the coproduct of $\dcoma$ to a coproduct on the ring of pipe dreams. However, there are some very special properties that make it work.
  \begin{itemize}
  \item The map $\phi = \iota\circ\pi_{\mathrm{Sch}}$ is an idempotent ring homomorphism from $\RC$ to itself whose kernel is the difference of pairs of pipe dreams with the same permutation.
  
  \item In fact, the decomposition
  $$\phi(R) + (R - \phi(R))$$
  is into direct summands, as $R - \phi(R)$ is also in the kernel of $\phi$.

  \item Since $\phi(\RC)$ is isomorphic to $\dcoma$, we can define a coproduct on $\phi(\RC)$ by transporting the coproduct of $\dcoma$ along this isomorphism on generators. The property of $\phi$ being a ring homomorphism then allows us to extend this to a coproduct on all of $\RC$ by defining 
  $$\Delta(R) = \Delta(\phi(R)) + (R - \phi(R))\otimes 1 + 1\otimes (R - \phi(R))$$
  \end{itemize}
\end{frame}

\begin{frame}{The dual ring of pipe dreams}
  Hence we may define a dual $\RC^*$ of $\RC$ with a dual basis $\{R^*\}$ and a dual product $*$ such that 
  $$\langle \Delta(P), R_1^*\otimes R_2^* \rangle = \langle P, R_1^**R_2^* \rangle.$$ 
  The map $\iota:\dcoma\hookrightarrow \RC$ induces a surjective ring homomorphism $\iota^*:\RC^*\twoheadrightarrow \coma$.
\begin{theorem}[S, 2026+]
The product $*$ is associative and commutative and gives a well-defined ring structure on $\RC^*$. Moreover, $\iota^*$ is a surjective ring homomorphism from $\RC^*$ to $\coma$ such that if we define
$$\mathcal{S}_w^n = \sum_{R\in\RC(w,n)} R^*,$$
then $\iota^*(\mathcal{S}_w^n) = \sch_{w}^n$. Hence the dual pipe dreams model Schubert polynomial multiplication, and the elements $\mathcal{S}_w^n$ have nonnegative structure constants under the projection to $\coma$.
\end{theorem}
  But of course, signs pop up to thwart a Littlewood-Richardson rule.
\end{frame}

\begin{frame}{Signed example}
\[
\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  ...
  \draw[blue, line width=0.5pt] (0,4.5) .. controls (0.3,4.5) and (0.5,4.7) .. (0.5,5);
  \draw[blue, line width=0.5pt] (0.5,4) .. controls (0.5,4.3) and (0.7,4.5) .. (1,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (1,4.5) -- (2,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (1.5,4) -- (1.5,5);
  ...
  \node[font=\bfseries, text=red, anchor=south] at (1.5,5.3) {4};
  \node[font=\bfseries, text=red, anchor=south] at (2.5,5.3) {2};
  \node[font=\bfseries, text=red, anchor=south] at (3.5,5.3) {3};
  \node[font=\bfseries, text=red, anchor=south] at (4.5,5.3) {5};
  ...
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,0.5) {5};
\end{tikzpicture}}}
\;\ast\;
\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (5,0);
  ...
  \draw[blue, line width=0.5pt, line cap=round] (1,4.5) -- (2,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (1.5,4) -- (1.5,5);
  \draw[blue, line width=0.5pt, line cap=round] (2,4.5) -- (3,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (2.5,4) -- (2.5,5);
  \draw[blue, line width=0.5pt] (3,4.5) .. controls (3.3,4.5) and (3.5,4.7) .. (3.5,5);
  \draw[blue, line width=0.5pt] (3.5,4) .. controls (3.5,4.3) and (3.7,4.5) .. (4,4.5);
  \draw[blue, line width=0.5pt] (4,4.5) .. controls (4.3,4.5) and (4.5,4.7) .. (4.5,5);
  \draw[blue, line width=0.5pt] (0,3.5) .. controls (0.3,3.5) and (0.5,3.7) .. (0.5,4);
  ...
  \draw[blue, line width=0.5pt] (1,1.5) .. controls (1.3,1.5) and (1.5,1.7) .. (1.5,2);
  \draw[blue, line width=0.5pt] (0,0.5) .. controls (0.3,0.5) and (0.5,0.7) .. (0.5,1);
  \node[font=\bfseries, text=red, anchor=south] at (0.5,5.3) {2};
  \node[font=\bfseries, text=red, anchor=south] at (1.5,5.3) {4};
  \node[font=\bfseries, text=red, anchor=south] at (2.5,5.3) {3};
  \node[font=\bfseries, text=red, anchor=south] at (3.5,5.3) {1};
  \node[font=\bfseries, text=red, anchor=south] at (4.5,5.3) {5};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,4.5) {1};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,3.5) {2};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,2.5) {3};
...
\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  ...
  \draw[blue, line width=0.5pt, line cap=round] (2,4.5) -- (3,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (2.5,4) -- (2.5,5);
  \draw[blue, line width=0.5pt, line cap=round] (3,4.5) -- (4,4.5);
  \draw[blue, line width=0.5pt, line cap=round] (3.5,4) -- (3.5,5);
  \draw[blue, line width=0.5pt] (4,4.5) .. controls (4.3,4.5) and (4.5,4.7) .. (4.5,5);
  \draw[blue, line width=0.5pt] (0,3.5) .. controls (0.3,3.5) and (0.5,3.7) .. (0.5,4);
  \draw[blue, line width=0.5pt] (0.5,3) .. controls (0.5,3.3) and (0.7,3.5) .. (1,3.5);
  \draw[blue, line width=0.5pt] (1,3.5) .. controls (1.3,3.5) and (1.5,3.7) .. (1.5,4);
  ...
  \node[font=\bfseries, text=red, anchor=south] at (0.5,5.3) {2};
  \node[font=\bfseries, text=red, anchor=south] at (1.5,5.3) {4};
  \node[font=\bfseries, text=red, anchor=south] at (2.5,5.3) {5};
  \node[font=\bfseries, text=red, anchor=south] at (3.5,5.3) {3};
  \node[font=\bfseries, text=red, anchor=south] at (4.5,5.3) {1};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,4.5) {1};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,3.5) {2};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,2.5) {3};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,1.5) {4};
...
\end{tikzpicture}}}
\;-\;
\tikz[baseline, remember picture]{\node[inner sep=0pt] (rightTopTerm) {$\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (5,0);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (0,5);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (5,1);
  \draw[lightgray, very thin, opacity=0.3] (1,0) -- (1,5);
  ...
  \draw[blue, line width=0.5pt] (1,1.5) .. controls (1.3,1.5) and (1.5,1.7) .. (1.5,2);
  \draw[blue, line width=0.5pt] (0,0.5) .. controls (0.3,0.5) and (0.5,0.7) .. (0.5,1);
  \node[font=\bfseries, text=red, anchor=south] at (0.5,5.3) {4};
  \node[font=\bfseries, text=red, anchor=south] at (1.5,5.3) {2};
  \node[font=\bfseries, text=red, anchor=south] at (2.5,5.3) {3};
  \node[font=\bfseries, text=red, anchor=south] at (3.5,5.3) {5};
  \node[font=\bfseries, text=red, anchor=south] at (4.5,5.3) {1};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,4.5) {1};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,3.5) {2};
  \node[font=\bfseries, text=blue, anchor=east] at (-0.3,2.5) {3};
...
\end{tikzpicture}}}
\;=\;
\tikz[baseline, remember picture]{\node[inner sep=0pt] (rightBottomTerm) {$\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (5,0);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (0,5);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (5,1);
  \draw[lightgray, very thin, opacity=0.3] (1,0) -- (1,5);
...
\begin{tikzpicture}[remember picture, overlay]
  \coordinate (rightPairMid) at ($(rightTopTerm.center)!0.5!(rightBottomTerm.center)+(-0.07cm,-0.02cm)$);
  \draw[line width=0.95pt, rotate around={-28:(rightPairMid)}]
    (rightPairMid) ellipse [x radius=1.18cm, y radius=2.37cm];
\end{tikzpicture}
\[
\vcenter{\hbox{\begin{tikzpicture}[scale=0.25, every node/.style={scale=0.7}]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (5,0);
