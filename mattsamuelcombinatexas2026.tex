...
\begin{itemize}
  ...
  \item Label the bottom by $2,3,\dots,n$ (left to right).
...
\begin{tikzpicture}[x=0.95cm,y=0.95cm,line cap=round,line join=round]
  ...
  \node[above] at (4.5,1) {$6$};
  \node[right] at (5,0.5) {$3$};
\end{tikzpicture}
\end{center}
...
\begin{frame}{Dual product of key polynomials}
