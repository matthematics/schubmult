...
$\RC_n$ such that there is an RC graph $R'$ that is the union of some $A\in\RC_n(S_n)$ with a commuting Grassmannian RC graph $P$ with $\hr(P) = 2n - 1$ such that the rows of $P$ with row index greater than $n$ are empty satisfying
$$\clp^n(R') = A$$
is $R\boxtimes p$.
\end{lemma}
