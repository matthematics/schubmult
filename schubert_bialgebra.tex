...
We exhibit a generating set for the ring structure.

\begin{theorem} \label{theorem:grassgen}
  The ring $(\BRC, \diamond)$ is generated by the set of bounded RC graphs $R$ such that $\wof{R}$ is a Grassmannian permutation with descent $\hr(R)$.
\end{theorem}
\begin{proof}
  Recall that the normal form of a permutation $w$ is a decomposition $w = v_1 v_2 \cdots v_k$ such that 
\end{proof}
