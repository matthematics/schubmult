...
for any RC graph $R$ and integer $k\geq 0$. Then choose an integer $N$ such that $N > i + j$ for all $(i, j) \in R_2$, and define
...
\begin{theorem}
The submodule of $\BRC_k$ generated as a ring by the RC graphs of $s_k$ under the squash product is isomorphic as a ring to $\mathcal{P}_k^{op}$ via the map $R_T:\mathcal{P}_k^{op}\to \RC$.
Furthermore, $\BRC_k$ is a right module over this ring, generated by the RC graphs of permutations $w\in S_n$. 
% The map $\zeromap:\BRC_k\to \BRC_{k-1}$ is a surjective homomorphism of right $\mathcal{P}_k$-modules.
\end{theorem}
% \begin{proof}
