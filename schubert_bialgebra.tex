...
We note that, when restricted to Grassmannian permutations, Theorem \ref{theorem:LR} reduces directly to a Littlewood--Richardson rule for Schur polynomials: if $u$, $v$, $w$ are Grassmannian with unique descents at $p$, $q$, $p+q$ corresponding to partitions $\lambda$, $\mu$, $\nu$, then $\dsch^p_u$, $\dsch^q_v$, $\dsch^{p+q}_w$ are precisely the Schur polynomials $s_\lambda(x_1,\ldots,x_p)$, $s_\mu(x_{p+1},\ldots,x_{p+q})$, $s_\nu(x_1,\ldots,x_{p+q})$, and the classical splitting
$$s_\nu(x_1,\ldots,x_{p+q}) = \sum_{\lambda,\mu} c^{\nu}_{\lambda,\mu}\, s_\lambda(x_1,\ldots,x_p)\, s_\mu(x_{p+1},\ldots,x_{p+q})$$
identifies $c^{\nu}_{\lambda,\mu} = d^{w}_{u,v}(p,q)$. Theorem \ref{theorem:LR} thus gives an alternative positive combinatorial rule for the classical Littlewood--Richardson coefficients in terms of RC graphs and the $\clp^p / \trm^p$ decomposition.
...
$$\kappa_a^*\kappa_b^* = \sum_{c} k_{a,b}^c\kappa_c^*$$
...
\section{The ring of RC graph crystals}
...
\end{lemma}
\begin{proof}
  The fact that $\Theta$ is a left ideal follows from the fact that the products $R\diamond R_1$ and $R\diamond R_2$ have the same first $\hr(R)$ rows, and the rows below are simply shifts of $R_1$ and $R_2$. Since the crystal raising/lowering operators act directly on adjacent rows, the same crystal operators will apply to the rows below, so that $R\diamond R_1$ and $R\diamond R_2$ have the same crystal structure in the trailing rows. In passing to highest weights $\mathbb{Y}(R\diamond R_1)$ and $\mathbb{Y}(R\diamond R_2)$, we may pass through the partial highest weights $R\diamond Y(R_1) = R\diamond Y(R_2)$, so that in particular the highest weights of the bijectively corresponding terms of $R\diamond R_1$ and $R\diamond R_2$ are the same.
  
  %, so that $R\diamond R_1 - R\diamond R_2$ is a linear combination of terms of the form $R_1' - R_2'$ such that $\mathbb{Y}(R_1') = \mathbb{Y}(R_2')$, and $\Theta$ is a left ideal.
...
$$\alpha(K_a)\alpha(K_b) = \kappa_a^*\kappa_b^*=\sum_{c}k_{ab}^c\kappa_c^*=\sum k_{a,b}^c\alpha(K_c),$$ 
it follows that $K_aK_b$ is a linear combination of the $K_c$, so the span of the $K_a$ is closed under multiplication, so that $\alpha$ is an isomorphism and we are done.
\end{proof}

\begin{proof}[Proof of Theorem \ref{theorem:LRkey}]
  The coefficient of $K_c$ in $K_aK_b$ is the same as the coefficient of $\kappa_c^*$ in $\kappa_a^*\kappa_b^*$, which is $k_{a,b}^c$ by definition. Since each of the summands of $K_c$ that are Demazure crystals of RC graphs are distinct from the summands of any other key element and each other, we need only consider one of the summands to read off the coefficient. The result follows.
\end{proof}

\begin{example}[Computing $\kappa_a^*\kappa_b^*$ for $a=(0,1,2)$, $b=(0,1,0,2)$]\label{example:LRkey}
...
\begin{tikzpicture}[scale=0.45]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (10,0);
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (0,10);
  \draw[lightgray, very thin, opacity=0.3] (0,1) -- (10,1);
  \draw[lightgray, very thin, opacity=0.3] (1,0) -- (1,10);
  \draw[lightgray, very thin, opacity=0.3] (0,2) -- (10,2);
  \draw[lightgray, very thin, opacity=0.3] (2,0) -- (2,10);
  \draw[lightgray, very thin, opacity=0.3] (0,3) -- (10,3);
  \draw[lightgray, very thin, opacity=0.3] (3,0) -- (3,10);
  \draw[lightgray, very thin, opacity=0.3] (0,4) -- (10,4);
  \draw[lightgray, very thin, opacity=0.3] (4,0) -- (4,10);
  \draw[lightgray, very thin, opacity=0.3] (0,5) -- (10,5);
  \draw[lightgray, very thin, opacity=0.3] (5,0) -- (5,10);
  \draw[lightgray, very thin, opacity=0.3] (0,6) -- (10,6);
  \draw[lightgray, very thin, opacity=0.3] (6,0) -- (6,10);
  \draw[lightgray, very thin, opacity=0.3] (0,7) -- (10,7);
  \draw[lightgray, very thin, opacity=0.3] (7,0) -- (7,10);
  \draw[lightgray, very thin, opacity=0.3] (0,8) -- (10,8);
  \draw[lightgray, very thin, opacity=0.3] (8,0) -- (8,10);
  \draw[lightgray, very thin, opacity=0.3] (0,9) -- (10,9);
  \draw[lightgray, very thin, opacity=0.3] (9,0) -- (9,10);
  \draw[lightgray, very thin, opacity=0.3] (0,10) -- (10,10);
  \draw[lightgray, very thin, opacity=0.3] (10,0) -- (10,10);
  \draw[blue, line width=1.125pt] (10,9.5) .. controls (9.7,9.5) and (9.5,9.7) .. (9.5,10);
  \draw[blue, line width=1.125pt] (9.5,9) .. controls (9.5,9.3) and (9.3,9.5) .. (9,9.5);
  \draw[blue, line width=1.125pt] (9,9.5) .. controls (8.7,9.5) and (8.5,9.7) .. (8.5,10);
  \draw[blue, line width=1.125pt] (8.5,9) .. controls (8.5,9.3) and (8.3,9.5) .. (8,9.5);
  \draw[blue, line width=1.125pt] (8,9.5) .. controls (7.7,9.5) and (7.5,9.7) .. (7.5,10);
  \draw[blue, line width=1.125pt] (7.5,9) .. controls (7.5,9.3) and (7.3,9.5) .. (7,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (7,9.5) -- (6,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (6.5,9) -- (6.5,10);
  \draw[blue, line width=1.125pt] (6,9.5) .. controls (5.7,9.5) and (5.5,9.7) .. (5.5,10);
  \draw[blue, line width=1.125pt] (5.5,9) .. controls (5.5,9.3) and (5.3,9.5) .. (5,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (5,9.5) -- (4,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (4.5,9) -- (4.5,10);
  \draw[blue, line width=1.125pt] (4,9.5) .. controls (3.7,9.5) and (3.5,9.7) .. (3.5,10);
  \draw[blue, line width=1.125pt] (3.5,9) .. controls (3.5,9.3) and (3.3,9.5) .. (3,9.5);
  \draw[blue, line width=1.125pt] (3,9.5) .. controls (2.7,9.5) and (2.5,9.7) .. (2.5,10);
  \draw[blue, line width=1.125pt] (2.5,9) .. controls (2.5,9.3) and (2.3,9.5) .. (2,9.5);
  \draw[blue, line width=1.125pt] (2,9.5) .. controls (1.7,9.5) and (1.5,9.7) .. (1.5,10);
  \draw[blue, line width=1.125pt] (1.5,9) .. controls (1.5,9.3) and (1.3,9.5) .. (1,9.5);
  \draw[blue, line width=1.125pt] (1,9.5) .. controls (0.7,9.5) and (0.5,9.7) .. (0.5,10);
  \draw[blue, line width=1.125pt] (10,8.5) .. controls (9.7,8.5) and (9.5,8.7) .. (9.5,9);
  \draw[blue, line width=1.125pt] (9.5,8) .. controls (9.5,8.3) and (9.3,8.5) .. (9,8.5);
  \draw[blue, line width=1.125pt] (9,8.5) .. controls (8.7,8.5) and (8.5,8.7) .. (8.5,9);
  \draw[blue, line width=1.125pt] (8.5,8) .. controls (8.5,8.3) and (8.3,8.5) .. (8,8.5);
  \draw[blue, line width=1.125pt] (8,8.5) .. controls (7.7,8.5) and (7.5,8.7) .. (7.5,9);
  \draw[blue, line width=1.125pt] (7.5,8) .. controls (7.5,8.3) and (7.3,8.5) .. (7,8.5);
  \draw[blue, line width=1.125pt] (7,8.5) .. controls (6.7,8.5) and (6.5,8.7) .. (6.5,9);
  \draw[blue, line width=1.125pt] (6.5,8) .. controls (6.5,8.3) and (6.3,8.5) .. (6,8.5);
  \draw[blue, line width=1.125pt] (6,8.5) .. controls (5.7,8.5) and (5.5,8.7) .. (5.5,9);
  \draw[blue, line width=1.125pt] (5.5,8) .. controls (5.5,8.3) and (5.3,8.5) .. (5,8.5);
  \draw[blue, line width=1.125pt] (5,8.5) .. controls (4.7,8.5) and (4.5,8.7) .. (4.5,9);
  \draw[blue, line width=1.125pt] (4.5,8) .. controls (4.5,8.3) and (4.3,8.5) .. (4,8.5);
  \draw[blue, line width=1.125pt] (4,8.5) .. controls (3.7,8.5) and (3.5,8.7) .. (3.5,9);
  \draw[blue, line width=1.125pt] (3.5,8) .. controls (3.5,8.3) and (3.3,8.5) .. (3,8.5);
  \draw[blue, line width=1.125pt, line cap=round] (3,8.5) -- (2,8.5);
  \draw[blue, line width=1.125pt, line cap=round] (2.5,8) -- (2.5,9);
  \draw[blue, line width=1.125pt] (2,8.5) .. controls (1.7,8.5) and (1.5,8.7) .. (1.5,9);
  \draw[blue, line width=1.125pt] (10,7.5) .. controls (9.7,7.5) and (9.5,7.7) .. (9.5,8);
  \draw[blue, line width=1.125pt] (9.5,7) .. controls (9.5,7.3) and (9.3,7.5) .. (9,7.5);
  \draw[blue, line width=1.125pt] (9,7.5) .. controls (8.7,7.5) and (8.5,7.7) .. (8.5,8);
  \draw[blue, line width=1.125pt] (8.5,7) .. controls (8.5,7.3) and (8.3,7.5) .. (8,7.5);
  \draw[blue, line width=1.125pt] (8,7.5) .. controls (7.7,7.5) and (7.5,7.7) .. (7.5,8);
  \draw[blue, line width=1.125pt] (7.5,7) .. controls (7.5,7.3) and (7.3,7.5) .. (7,7.5);
  \draw[blue, line width=1.125pt] (7,7.5) .. controls (6.7,7.5) and (6.5,7.7) .. (6.5,8);
  \draw[blue, line width=1.125pt] (6.5,7) .. controls (6.5,7.3) and (6.3,7.5) .. (6,7.5);
  \draw[blue, line width=1.125pt] (6,7.5) .. controls (5.7,7.5) and (5.5,7.7) .. (5.5,8);
  \draw[blue, line width=1.125pt] (5.5,7) .. controls (5.5,7.3) and (5.3,7.5) .. (5,7.5);
  \draw[blue, line width=1.125pt] (5,7.5) .. controls (4.7,7.5) and (4.5,7.7) .. (4.5,8);
  \draw[blue, line width=1.125pt] (4.5,7) .. controls (4.5,7.3) and (4.3,7.5) .. (4,7.5);
  \draw[blue, line width=1.125pt] (4,7.5) .. controls (3.7,7.5) and (3.5,7.7) .. (3.5,8);
  \draw[blue, line width=1.125pt] (3.5,7) .. controls (3.5,7.3) and (3.3,7.5) .. (3,7.5);
  \draw[blue, line width=1.125pt] (3,7.5) .. controls (2.7,7.5) and (2.5,7.7) .. (2.5,8);
  \draw[blue, line width=1.125pt] (10,6.5) .. controls (9.7,6.5) and (9.5,6.7) .. (9.5,7);
  \draw[blue, line width=1.125pt] (9.5,6) .. controls (9.5,6.3) and (9.3,6.5) .. (9,6.5);
  \draw[blue, line width=1.125pt, line cap=round] (9,6.5) -- (8,6.5);
  \draw[blue, line width=1.125pt, line cap=round] (8.5,6) -- (8.5,7);
  \draw[blue, line width=1.125pt] (8,6.5) .. controls (7.7,6.5) and (7.5,6.7) .. (7.5,7);
  \draw[blue, line width=1.125pt] (7.5,6) .. controls (7.5,6.3) and (7.3,6.5) .. (7,6.5);
  \draw[blue, line width=1.125pt] (7,6.5) .. controls (6.7,6.5) and (6.5,6.7) .. (6.5,7);
  \draw[blue, line width=1.125pt] (6.5,6) .. controls (6.5,6.3) and (6.3,6.5) .. (6,6.5);
  \draw[blue, line width=1.125pt, line cap=round] (6,6.5) -- (5,6.5);
  \draw[blue, line width=1.125pt, line cap=round] (5.5,6) -- (5.5,7);
  \draw[blue, line width=1.125pt] (5,6.5) .. controls (4.7,6.5) and (4.5,6.7) .. (4.5,7);
  \draw[blue, line width=1.125pt] (4.5,6) .. controls (4.5,6.3) and (4.3,6.5) .. (4,6.5);
  \draw[blue, line width=1.125pt] (4,6.5) .. controls (3.7,6.5) and (3.5,6.7) .. (3.5,7);
  \draw[blue, line width=1.125pt] (10,5.5) .. controls (9.7,5.5) and (9.5,5.7) .. (9.5,6);
  \draw[blue, line width=1.125pt] (9.5,5) .. controls (9.5,5.3) and (9.3,5.5) .. (9,5.5);
  \draw[blue, line width=1.125pt] (9,5.5) .. controls (8.7,5.5) and (8.5,5.7) .. (8.5,6);
  \draw[blue, line width=1.125pt] (8.5,5) .. controls (8.5,5.3) and (8.3,5.5) .. (8,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (8,5.5) -- (7,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (7.5,5) -- (7.5,6);
  \draw[blue, line width=1.125pt] (7,5.5) .. controls (6.7,5.5) and (6.5,5.7) .. (6.5,6);
  \draw[blue, line width=1.125pt] (6.5,5) .. controls (6.5,5.3) and (6.3,5.5) .. (6,5.5);
  \draw[blue, line width=1.125pt] (6,5.5) .. controls (5.7,5.5) and (5.5,5.7) .. (5.5,6);
  \draw[blue, line width=1.125pt] (5.5,5) .. controls (5.5,5.3) and (5.3,5.5) .. (5,5.5);
  \draw[blue, line width=1.125pt] (5,5.5) .. controls (4.7,5.5) and (4.5,5.7) .. (4.5,6);
  \draw[blue, line width=1.125pt] (10,4.5) .. controls (9.7,4.5) and (9.5,4.7) .. (9.5,5);
  \draw[blue, line width=1.125pt] (9.5,4) .. controls (9.5,4.3) and (9.3,4.5) .. (9,4.5);
  \draw[blue, line width=1.125pt] (9,4.5) .. controls (8.7,4.5) and (8.5,4.7) .. (8.5,5);
  \draw[blue, line width=1.125pt] (8.5,4) .. controls (8.5,4.3) and (8.3,4.5) .. (8,4.5);
  \draw[blue, line width=1.125pt] (8,4.5) .. controls (7.7,4.5) and (7.5,4.7) .. (7.5,5);
  \draw[blue, line width=1.125pt] (7.5,4) .. controls (7.5,4.3) and (7.3,4.5) .. (7,4.5);
  \draw[blue, line width=1.125pt] (7,4.5) .. controls (6.7,4.5) and (6.5,4.7) .. (6.5,5);
  \draw[blue, line width=1.125pt] (6.5,4) .. controls (6.5,4.3) and (6.3,4.5) .. (6,4.5);
  \draw[blue, line width=1.125pt] (6,4.5) .. controls (5.7,4.5) and (5.5,4.7) .. (5.5,5);
  \draw[blue, line width=1.125pt] (10,3.5) .. controls (9.7,3.5) and (9.5,3.7) .. (9.5,4);
  \draw[blue, line width=1.125pt] (9.5,3) .. controls (9.5,3.3) and (9.3,3.5) .. (9,3.5);
  \draw[blue, line width=1.125pt] (9,3.5) .. controls (8.7,3.5) and (8.5,3.7) .. (8.5,4);
  \draw[blue, line width=1.125pt] (8.5,3) .. controls (8.5,3.3) and (8.3,3.5) .. (8,3.5);
  \draw[blue, line width=1.125pt] (8,3.5) .. controls (7.7,3.5) and (7.5,3.7) .. (7.5,4);
  \draw[blue, line width=1.125pt] (7.5,3) .. controls (7.5,3.3) and (7.3,3.5) .. (7,3.5);
  \draw[blue, line width=1.125pt] (7,3.5) .. controls (6.7,3.5) and (6.5,3.7) .. (6.5,4);
  \draw[blue, line width=1.125pt] (10,2.5) .. controls (9.7,2.5) and (9.5,2.7) .. (9.5,3);
  \draw[blue, line width=1.125pt] (9.5,2) .. controls (9.5,2.3) and (9.3,2.5) .. (9,2.5);
  \draw[blue, line width=1.125pt] (9,2.5) .. controls (8.7,2.5) and (8.5,2.7) .. (8.5,3);
  \draw[blue, line width=1.125pt] (8.5,2) .. controls (8.5,2.3) and (8.3,2.5) .. (8,2.5);
  \draw[blue, line width=1.125pt] (8,2.5) .. controls (7.7,2.5) and (7.5,2.7) .. (7.5,3);
  \draw[blue, line width=1.125pt] (10,1.5) .. controls (9.7,1.5) and (9.5,1.7) .. (9.5,2);
  \draw[blue, line width=1.125pt] (9.5,1) .. controls (9.5,1.3) and (9.3,1.5) .. (9,1.5);
  \draw[blue, line width=1.125pt] (9,1.5) .. controls (8.7,1.5) and (8.5,1.7) .. (8.5,2);
  \draw[blue, line width=1.125pt] (10,0.5) .. controls (9.7,0.5) and (9.5,0.7) .. (9.5,1);
  \node[font=\bfseries, text=blue, anchor=south] at (9.5,10.3) {1};
  \node[font=\bfseries, text=blue, anchor=south] at (8.5,10.3) {2};
  \node[font=\bfseries, text=blue, anchor=south] at (7.5,10.3) {3};
  \node[font=\bfseries, text=blue, anchor=south] at (6.5,10.3) {4};
  \node[font=\bfseries, text=blue, anchor=south] at (5.5,10.3) {5};
  \node[font=\bfseries, text=blue, anchor=south] at (4.5,10.3) {6};
  \node[font=\bfseries, text=blue, anchor=south] at (3.5,10.3) {7};
  \node[font=\bfseries, text=blue, anchor=south] at (2.5,10.3) {8};
  \node[font=\bfseries, text=blue, anchor=south] at (1.5,10.3) {9};
  \node[font=\bfseries, text=blue, anchor=south] at (0.5,10.3) {10};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,9.5) {1};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,8.5) {2};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,7.5) {3};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,6.5) {5};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,5.5) {7};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,4.5) {4};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,3.5) {10};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,2.5) {6};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,1.5) {8};
  \node[font=\bfseries, text=blue, anchor=west] at (10.3,0.5) {9};
  \draw[black, line width=1.35pt] (0,7) rectangle (10,10);
\end{tikzpicture}
&
\begin{tikzpicture}[scale=0.45]
  \draw[lightgray, very thin, opacity=0.3] (0,0) -- (10,0);
  ...
  \draw[blue, line width=1.125pt] (6,9.5) .. controls (5.7,9.5) and (5.5,9.7) .. (5.5,10);
  \draw[blue, line width=1.125pt] (5.5,9) .. controls (5.5,9.3) and (5.3,9.5) .. (5,9.5);
  \draw[blue, line width=1.125pt] (5,9.5) .. controls (4.7,9.5) and (4.5,9.7) .. (4.5,10);
  \draw[blue, line width=1.125pt] (4.5,9) .. controls (4.5,9.3) and (4.3,9.5) .. (4,9.5);
  \draw[blue, line width=1.125pt] (4,9.5) .. controls (3.7,9.5) and (3.5,9.7) .. (3.5,10);
  \draw[blue, line width=1.125pt] (3.5,9) .. controls (3.5,9.3) and (3.3,9.5) .. (3,9.5);
  \draw[blue, line width=1.125pt] (3,9.5) .. controls (2.7,9.5) and (2.5,9.7) .. (2.5,10);
  \draw[blue, line width=1.125pt] (2.5,9) .. controls (2.5,9.3) and (2.3,9.5) .. (2,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (2,9.5) -- (1,9.5);
  \draw[blue, line width=1.125pt, line cap=round] (1.5,9) -- (1.5,10);
  \draw[blue, line width=1.125pt] (1,9.5) .. controls (0.7,9.5) and (0.5,9.7) .. (0.5,10);
  \draw[blue, line width=1.125pt] (10,8.5) .. controls (9.7,8.5) and (9.5,8.7) .. (9.5,9);
  \draw[blue, line width=1.125pt] (9.5,8) .. controls (9.5,8.3) and (9.3,8.5) .. (9,8.5);
  \draw[blue, line width=1.125pt] (9,8.5) .. controls (8.7,8.5) and (8.5,8.7) .. (8.5,9);
  ...
  \draw[blue, line width=1.125pt] (7,8.5) .. controls (6.7,8.5) and (6.5,8.7) .. (6.5,9);
  \draw[blue, line width=1.125pt] (6.5,8) .. controls (6.5,8.3) and (6.3,8.5) .. (6,8.5);
  \draw[blue, line width=1.125pt, line cap=round] (6,8.5) -- (5,8.5);
  \draw[blue, line width=1.125pt, line cap=round] (5.5,8) -- (5.5,9);
  \draw[blue, line width=1.125pt] (5,8.5) .. controls (4.7,8.5) and (4.5,8.7) .. (4.5,9);
  \draw[blue, line width=1.125pt] (4.5,8) .. controls (4.5,8.3) and (4.3,8.5) .. (4,8.5);
  \draw[blue, line width=1.125pt] (4,8.5) .. controls (3.7,8.5) and (3.5,8.7) .. (3.5,9);
  \draw[blue, line width=1.125pt] (3.5,8) .. controls (3.5,8.3) and (3.3,8.5) .. (3,8.5);
  \draw[blue, line width=1.125pt] (3,8.5) .. controls (2.7,8.5) and (2.5,8.7) .. (2.5,9);
  \draw[blue, line width=1.125pt] (2.5,8) .. controls (2.5,8.3) and (2.3,8.5) .. (2,8.5);
  \draw[blue, line width=1.125pt] (2,8.5) .. controls (1.7,8.5) and (1.5,8.7) .. (1.5,9);
  \draw[blue, line width=1.125pt] (10,7.5) .. controls (9.7,7.5) and (9.5,7.7) .. (9.5,8);
  \draw[blue, line width=1.125pt] (9.5,7) .. controls (9.5,7.3) and (9.3,7.5) .. (9,7.5);
  \draw[blue, line width=1.125pt] (9,7.5) .. controls (8.7,7.5) and (8.5,7.7) .. (8.5,8);
...
\begin{tikzpicture}[scale=0.45, baseline=(current bounding box.center)]
  ...
  \draw[blue, line width=1.125pt] (5,4.5) .. controls (4.7,4.5) and (4.5,4.7) .. (4.5,5);
  \draw[blue, line width=1.125pt] (4.5,4) .. controls (4.5,4.3) and (4.3,4.5) .. (4,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (4,4.5) -- (3,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (3.5,4) -- (3.5,5);
  \draw[blue, line width=1.125pt] (3,4.5) .. controls (2.7,4.5) and (2.5,4.7) .. (2.5,5);
  \draw[blue, line width=1.125pt] (2.5,4) .. controls (2.5,4.3) and (2.3,4.5) .. (2,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (2,4.5) -- (1,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (1.5,4) -- (1.5,5);
  \draw[blue, line width=1.125pt] (1,4.5) .. controls (0.7,4.5) and (0.5,4.7) .. (0.5,5);
  \draw[blue, line width=1.125pt] (5,3.5) .. controls (4.7,3.5) and (4.5,3.7) .. (4.5,4);
  \draw[blue, line width=1.125pt] (4.5,3) .. controls (4.5,3.3) and (4.3,3.5) .. (4,3.5);
  \draw[blue, line width=1.125pt, line cap=round] (4,3.5) -- (3,3.5);
  \draw[blue, line width=1.125pt, line cap=round] (3.5,3) -- (3.5,4);
  \draw[blue, line width=1.125pt] (3,3.5) .. controls (2.7,3.5) and (2.5,3.7) .. (2.5,4);
  \draw[blue, line width=1.125pt] (2.5,3) .. controls (2.5,3.3) and (2.3,3.5) .. (2,3.5);
  \draw[blue, line width=1.125pt] (2,3.5) .. controls (1.7,3.5) and (1.5,3.7) .. (1.5,4);
  \draw[blue, line width=1.125pt] (5,2.5) .. controls (4.7,2.5) and (4.5,2.7) .. (4.5,3);
  \draw[blue, line width=1.125pt] (4.5,2) .. controls (4.5,2.3) and (4.3,2.5) .. (4,2.5);
  \draw[blue, line width=1.125pt] (4,2.5) .. controls (3.7,2.5) and (3.5,2.7) .. (3.5,3);
  \draw[blue, line width=1.125pt] (3.5,2) .. controls (3.5,2.3) and (3.3,2.5) .. (3,2.5);
  \draw[blue, line width=1.125pt] (3,2.5) .. controls (2.7,2.5) and (2.5,2.7) .. (2.5,3);
  \draw[blue, line width=1.125pt] (5,1.5) .. controls (4.7,1.5) and (4.5,1.7) .. (4.5,2);
  \draw[blue, line width=1.125pt] (4.5,1) .. controls (4.5,1.3) and (4.3,1.5) .. (4,1.5);
  \draw[blue, line width=1.125pt] (4,1.5) .. controls (3.7,1.5) and (3.5,1.7) .. (3.5,2);
  \draw[blue, line width=1.125pt] (5,0.5) .. controls (4.7,0.5) and (4.5,0.7) .. (4.5,1);
  \node[font=\bfseries, text=blue, anchor=south] at (4.5,5.3) {1};
  \node[font=\bfseries, text=blue, anchor=south] at (3.5,5.3) {2};
  \node[font=\bfseries, text=blue, anchor=south] at (2.5,5.3) {3};
  \node[font=\bfseries, text=blue, anchor=south] at (1.5,5.3) {4};
  \node[font=\bfseries, text=blue, anchor=south] at (0.5,5.3) {5};
  \node[font=\bfseries, text=blue, anchor=west] at (5.3,4.5) {1};
  \node[font=\bfseries, text=blue, anchor=west] at (5.3,3.5) {3};
  \node[font=\bfseries, text=blue, anchor=west] at (5.3,2.5) {5};
  \node[font=\bfseries, text=blue, anchor=west] at (5.3,1.5) {2};
  \node[font=\bfseries, text=blue, anchor=west] at (5.3,0.5) {4};
\end{tikzpicture}
$$
...
\begin{tikzpicture}[scale=0.45, baseline=(current bounding box.center)]
  ...
  \draw[blue, line width=1.125pt] (6,5.5) .. controls (5.7,5.5) and (5.5,5.7) .. (5.5,6);
  \draw[blue, line width=1.125pt] (5.5,5) .. controls (5.5,5.3) and (5.3,5.5) .. (5,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (5,5.5) -- (4,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (4.5,5) -- (4.5,6);
  \draw[blue, line width=1.125pt] (4,5.5) .. controls (3.7,5.5) and (3.5,5.7) .. (3.5,6);
  \draw[blue, line width=1.125pt] (3.5,5) .. controls (3.5,5.3) and (3.3,5.5) .. (3,5.5);
  \draw[blue, line width=1.125pt] (3,5.5) .. controls (2.7,5.5) and (2.5,5.7) .. (2.5,6);
  \draw[blue, line width=1.125pt] (2.5,5) .. controls (2.5,5.3) and (2.3,5.5) .. (2,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (2,5.5) -- (1,5.5);
  \draw[blue, line width=1.125pt, line cap=round] (1.5,5) -- (1.5,6);
  \draw[blue, line width=1.125pt] (1,5.5) .. controls (0.7,5.5) and (0.5,5.7) .. (0.5,6);
  \draw[blue, line width=1.125pt] (6,4.5) .. controls (5.7,4.5) and (5.5,4.7) .. (5.5,5);
  \draw[blue, line width=1.125pt] (5.5,4) .. controls (5.5,4.3) and (5.3,4.5) .. (5,4.5);
  \draw[blue, line width=1.125pt] (5,4.5) .. controls (4.7,4.5) and (4.5,4.7) .. (4.5,5);
  \draw[blue, line width=1.125pt] (4.5,4) .. controls (4.5,4.3) and (4.3,4.5) .. (4,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (4,4.5) -- (3,4.5);
  \draw[blue, line width=1.125pt, line cap=round] (3.5,4) -- (3.5,5);
  \draw[blue, line width=1.125pt] (3,4.5) .. controls (2.7,4.5) and (2.5,4.7) .. (2.5,5);
  \draw[blue, line width=1.125pt] (2.5,4) .. controls (2.5,4.3) and (2.3,4.5) .. (2,4.5);
  \draw[blue, line width=1.125pt] (2,4.5) .. controls (1.7,4.5) and (1.5,4.7) .. (1.5,5);
  \draw[blue, line width=1.125pt] (6,3.5) .. controls (5.7,3.5) and (5.5,3.7) .. (5.5,4);
  \draw[blue, line width=1.125pt] (5.5,3) .. controls (5.5,3.3) and (5.3,3.5) .. (5,3.5);
  \draw[blue, line width=1.125pt] (5,3.5) .. controls (4.7,3.5) and (4.5,3.7) .. (4.5,4);
  \draw[blue, line width=1.125pt] (4.5,3) .. controls (4.5,3.3) and (4.3,3.5) .. (4,3.5);
  \draw[blue, line width=1.125pt] (4,3.5) .. controls (3.7,3.5) and (3.5,3.7) .. (3.5,4);
  \draw[blue, line width=1.125pt] (3.5,3) .. controls (3.5,3.3) and (3.3,3.5) .. (3,3.5);
  \draw[blue, line width=1.125pt] (3,3.5) .. controls (2.7,3.5) and (2.5,3.7) .. (2.5,4);
  \draw[blue, line width=1.125pt] (6,2.5) .. controls (5.7,2.5) and (5.5,2.7) .. (5.5,3);
  \draw[blue, line width=1.125pt] (5.5,2) .. controls (5.5,2.3) and (5.3,2.5) .. (5,2.5);
  \draw[blue, line width=1.125pt] (5,2.5) .. controls (4.7,2.5) and (4.5,2.7) .. (4.5,3);
  \draw[blue, line width=1.125pt] (4.5,2) .. controls (4.5,2.3) and (4.3,2.5) .. (4,2.5);
  \draw[blue, line width=1.125pt] (4,2.5) .. controls (3.7,2.5) and (3.5,2.7) .. (3.5,3);
  \draw[blue, line width=1.125pt] (6,1.5) .. controls (5.7,1.5) and (5.5,1.7) .. (5.5,2);
  \draw[blue, line width=1.125pt] (5.5,1) .. controls (5.5,1.3) and (5.3,1.5) .. (5,1.5);
  \draw[blue, line width=1.125pt] (5,1.5) .. controls (4.7,1.5) and (4.5,1.7) .. (4.5,2);
  \draw[blue, line width=1.125pt] (6,0.5) .. controls (5.7,0.5) and (5.5,0.7) .. (5.5,1);
  \node[font=\bfseries, text=blue, anchor=south] at (5.5,6.3) {1};
  \node[font=\bfseries, text=blue, anchor=south] at (4.5,6.3) {2};
  \node[font=\bfseries, text=blue, anchor=south] at (3.5,6.3) {3};
  \node[font=\bfseries, text=blue, anchor=south] at (2.5,6.3) {4};
  \node[font=\bfseries, text=blue, anchor=south] at (1.5,6.3) {5};
  \node[font=\bfseries, text=blue, anchor=south] at (0.5,6.3) {6};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,5.5) {1};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,4.5) {3};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,3.5) {2};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,2.5) {6};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,1.5) {4};
  \node[font=\bfseries, text=blue, anchor=west] at (6.3,0.5) {5};
\end{tikzpicture}
$$
...
\begin{example}[Computing $\forest_a^*\forest_b^*$ for $a=(0,0,2,0,2)$, $b=(0,1,0,0,2)$]\label{example:LRforest}
Let
$$a=(0,0,2,0,2),\qquad b=(0,1,0,0,2),\qquad c=(0,0,1,0,1,0,2,0,0,3).$$
Here $p=q=5$, so we count $10$-row RC graphs in the class indexed by $c$ whose top and bottom parts lie in the forest classes for $a$ and $b$ respectively.

The relevant set is
\[
\mathcal{S}_{a,b}^c=
\{(R,R_1,R_2)\in\texttt{spinach}:
R_1.\texttt{forest\_weight}=a,\ R_2.\texttt{forest\_weight}=b,
R_1.\texttt{length\_vector}=R_1.\texttt{forest\_weight},
R_2.\texttt{length\_vector}=R_2.\texttt{forest\_weight}\}.
\]
Its two witness graphs are
\[
\begin{aligned}
R_1 &= \mathrm{RCGraph}([(),(),(5,3),(),(12,8),(),(7,),(),(),(11,10)]),\\
R_2 &= \mathrm{RCGraph}([(),(),(8,3),(),(12,5),(),(7,),(),(),(11,10)]).
\end{aligned}
\]
Both have permutation
$$\wof{R_1}=\wof{R_2}=(1,2,4,3,6,5,9,7,8,13,10,11,12).$$

With your corrected clip/trim condition,
\[
(\clp^5(R_i),\trm^5(R_i))=
\bigl(\mathrm{RCGraph}([(),(),(4,3),(),(6,5)]),\ \mathrm{RCGraph}([(),(2,),(),(),(6,5)])\bigr)
\]
for $i=1,2$, and these representatives have forest weights $a$ and $b$ respectively.

\begin{figure}[h]
\centering
\begin{tabular}{cc}
\resizebox{0.43\textwidth}{!}{\input{images/forest_lr_R1.tikz}} &
\resizebox{0.43\textwidth}{!}{\input{images/forest_lr_R2.tikz}} \\
$(R_1)$ & $(R_2)$
\end{tabular}
...
\centering
\begin{tabular}{cc}
\resizebox{0.35\textwidth}{!}{\input{images/forest_lr_clip.tikz}} &
\resizebox{0.35\textwidth}{!}{\input{images/forest_lr_trim.tikz}} \\
$\clp^5(R_i)$ & $\trm^5(R_i)$
\end{tabular}
...
Therefore $\#\mathcal{S}_{a,b}^c=2$, so Theorem~\ref{theorem:LRforest} gives
$$f_{a,b}^c=2.$$ 
\end{example}
...
\section{Product rule for dual slide polynomials}
\subsection{Slide polynomials}

RC graph is a triple $(w,E,\alpha)$ where $w$ is a permutation, 
$$E:I(w)\to [\ell(w)]$$
is a linear extension, and $\alpha:I(w)\to \mathbb{Z}_{>0}$ is a compatible sequence.

\begin{definition}
Slide polynomials $\mathfrak{F}(\mathbf{r})$ for a word $\mathbf{r}$ are defined by summing over all compatible sequences of $\mathbf{r}$. They can be characterized as follows.
...
For each $c$, fix an RC graph $C$ with $\wtt(\QY(C)) = c$. Then $s_{a,b}^c$ is the number of distinct RC graphs $R$ with $\mathrm{word}(R)=\mathrm{word}(C)$ such that $\wtt(\QY(\clp^p(R))) = a$ and $\wtt(\QY(\trm^p(R))) = b$.
\end{theorem}

\subsection{A general ideal-quotient Littlewood--Richardson principle}

The previous sections suggest a common mechanism behind the dual Schubert, dual key, dual forest, and (conjecturally in full detail) dual slide formulas. We record it here as a template theorem.

\begin{theorem}[General LR principle via quotients of $\BRC$]\label{theorem:general_lr_template}
Suppose for each permutation $w$ and integer $n\geq \maxd(w)$ we have an equivalence relation $\sim$ satisfying the following:
\begin{itemize}
\item[(1)] If $R_1\sim R_2$ and $1\leq p\leq \hr(R_1)$, then
$$\clp^p(R_1)\sim \clp^p(R_2),\qquad \trm^p(R_1)\sim \trm^p(R_2).$$
%two-sided ideal $I\subseteq \BRC$ such that $I\subseteq \Omega$, where $\Omega=\ker(\alpha)$ from Theorem~\ref{theorem:semidirect}.
\item[(2)] The set of all $\mathfrak{B}_R\in\coma_n$ for $R\in\RC_n$ such that
$$\mathfrak{B}_R = \sum_{R'\sim R} \wtt(R')$$
forms a $\mathbb{Z}$-basis of $\coma_n$.
\end{itemize}
Then the structure constants
$$\mathfrak{B}_\mu^*\mathfrak{B}_\nu^*=\sum b_{\mu,\nu}^{\lambda}\, \mathfrak{B}_\lambda^*$$
satisfy
$$b_{\mu,\nu}^{\lambda}=\#\Bigl\{R\sim R_\lambda:\ \mathfrak{B}_{\clp^p(R)}=\mathfrak{B}_\mu,\ \mathfrak{B}_{\trm^p(R)}=\mathfrak{B}_\nu\Bigr\},$$
where $R_\lambda$ is an arbitrary fixed RC graph such that $\mathfrak{B}_{R_\lambda}=\mathfrak{B}_\lambda$. Hence $b_{\mu,\nu}^{\lambda}\geq 0$.
\end{theorem}

\begin{proof}[Proof attempt]
Since $I\subseteq\Omega=\ker(\alpha)$, the map $\alpha:\BRC\to\dcoma$ factors through a ring homomorphism
$$\alpha_I:\BRC/I\to\dcoma.$$
By hypothesis (1), the sets $\mathcal{C}_\lambda$ partition the basis elements of $\BRC/I$ in each length, so the $E_\lambda$ are automatically linearly independent (disjoint supports, unit coefficients). By hypothesis (3), $\alpha_I(E_\lambda)=\mathfrak{B}_\lambda^*$, so
$$\alpha_I(E_\mu E_\nu)=\mathfrak{B}_\mu^*\mathfrak{B}_\nu^*=\sum_\lambda b_{\mu,\nu}^{\lambda}\mathfrak{B}_\lambda^*.$$
Because the $\mathfrak{B}_\lambda^*$ are linearly independent, $b_{\mu,\nu}^{\lambda}$ is the coefficient of $E_\lambda$ in the product $E_\mu E_\nu$ in $\BRC/I$.

Expand $E_\mu E_\nu$ by multiplying chosen representatives from each $\mathcal{C}$ set using the product $\diamond$ and the $(\clp^p,\trm^p)$ decomposition (Definition and Theorem~\ref{theorem:modactrc}). By hypothesis (5), the condition for an RC graph $R$ to contribute to the $\lambda$-component depends only on its class in $\BRC/I$, ensuring that the coefficient of $E_\lambda$ is well-defined and equals the cardinality of the fiber
$$\Bigl\{R\in\mathcal{C}_\lambda:\ \clp^p(R)/I\in \mathcal{C}_\mu,\ \trm^p(R)/I\in \mathcal{C}_\nu\Bigr\}.$$
Since this is a cardinality, $b_{\mu,\nu}^{\lambda}\geq 0$.

The argument is modular: once hypotheses (1)--(5) are verified for a quotient theory (Schubert, key, forest, slide), the corresponding Littlewood--Richardson rule and positivity follow.
\end{proof}

\begin{remark}
In the present paper, Theorem~\ref{theorem:general_lr_template} is instantiated by
\begin{itemize}
\item $I=\Omega$ for the dual Schubert basis,
\item $I=\Theta$ for the dual key basis,
\item $I=\Gamma$ for the dual forest basis.
\end{itemize}
For dual slide polynomials, this theorem indicates the remaining formal step: identify the corresponding ideal and verify the analogue of (1)--(5) explicitly.
\end{remark}

\section{A ring modeling {$\coma$}}

\subsection{The elementary tensor algebra}
\begin{definition}
...
\begin{definition}
Consider the ring $\mathcal{T}_n$ defined as
$$\mathcal{T}_n = \bigotimes_{k=1}^n \grass_k^{\otimes k}$$
%where $\sim$ is the equivalence relation generated by the following:
%the tensor algebra on the free abelian groups generated by the set of full $k$-Grassmannian elementary symmetric polynomial RC graphs (i.e. single columns), satisfying the additional condition that if $ A\otimes B$ are such that $\hr(A)\neq \hr(B)$, then

We then define a linear homomorphism
$$\mathcal{T}_n\to \BRC_n$$
by
...
Define $\mathbf{E}_{p,k}^n$ to be the sum of all full $k$-Grassmannian elementary symmetric polynomial RC graphs of degree $p$, considered as an element of $\mathcal{T}_n$.
\end{definition}
...
$$\RC_n(\mathbf{E}_{p_1,k_1}^n\otimes \mathbf{E}_{p_2,k_2}^n\otimes \cdots \otimes \mathbf{E}_{p_m,k_m}^n) = \sum_{w} c_w\mathcal{S}_w(n)$$
...
$$\RC_n(\mathbf{E}_{p_1,k_1}^n\otimes \cdots \otimes \mathbf{E}_{p_m,k_m}^n) = \RC_n(\mathbf{E}_{p_1,k_1}^n\otimes \cdots \otimes \mathbf{E}_{p_{m-1},k_{m-1}}^n)\boxtimes \RC_n(\mathbf{E}_{p_m,k_m}^n)=\sum_{w'} c_{w'}' \mathcal{S}_{w'}(n)\boxtimes \mathbf{E}_{p_m,k_m}^n$$
by Theorem \ref{theorem:schubmoduleiso}, since $\mathbf{E}_{p_m,k_m}^n\in\grass_{k_m}$, and we are ensured by the increasing order of $k_i$ that the left factor can be clipped to height $k_m$ without the permutation changing. We then apply Proposition \ref{proposition:boxproduct} to obtain the result for a single term of this type by induction. Invoking the fact that the image lies in $\mathrm{Schub}_n$, the result follows by applying Theorem \ref{theorem:schubmoduleiso}.
\end{proof}
...
% The projection $\mathcal{T}_n\to \mathbb{Z}[x_1,\ldots,x_n]$ is a surjective homomorphism of rings such that the subring generated by the $\mathbf{E}_{p,k}^n$ factors via $\RC$ through the isomorphism of $\Lambda_n$-modules $\mathbb{Z}\mathcal{S}_w(n)\to\mathbb{Z}[x_1,\ldots,x_n]$ sending $\mathcal{S}_w(n)$ to $\sch_w(x)$.
% \end{theorem}
% \begin{proof}
...
\begin{definition}
  Suppose $\maxd(w)\leq n$. We define an element $\mathbf{S}_w(n)\in \mathcal{T}_n$ by
  $$\mathbf{S}_w(n) = \sum_{\alpha} E_w^{\alpha;n}\mathbf{E}_{\alpha_1,1}^1\otimes \mathbf{E}_{\alpha_2,2}^2\otimes \cdots \otimes \mathbf{E}_{\alpha_n,n}^n\otimes \mathbf{E}_{\alpha_{n+1}, n}^n\otimes\cdots \otimes \mathbf{E}_{\alpha_N,n}^n$$
\end{definition}
...
\begin{proof}
  Explicitly, write
  $$\mathbf{S}_u(n)\mathbf{S}_v(n) = \sum_{\alpha,\beta} E_u^{\alpha;n}E_v^{\beta;n} \mathbf{E}_{\alpha_1,1}^1\otimes \cdots \otimes \mathbf{E}_{\alpha_N,n}^n\otimes \mathbf{E}_{\beta_1,1}^1\otimes \cdots \otimes \mathbf{E}_{\beta_N,n}^n$$
  The relations of the ring allow us to slide smaller terms in $\mathbf{S}_v(n)$ past strictly larger terms in $\mathbf{S}_u(n)$, so we may rearrange the tensor into one that is in increasing order. The result then follows from Proposition \ref{proposition:eproductworks} and the fact that the image of $\RC$ lies in $\mathrm{Schub}_n$, so that we may invoke Theorem \ref{theorem:schubmoduleiso}.
\end{proof}

It may be unsurprising to the reader at this point that the kernel of $\RC:\mathcal{T}_n\to \BRC_n$ \emph{is not an ideal}. If it were, then the product on $\mathcal{T}_n$ would descend to a term by term product such that
...
\subsection{The slide ring}
\begin{definition}
  Define a function $\mathrm{lift}_n:\RC_n(S_{n+1})\to \mathcal{T}_n$ as follows. For an RC graph $R\in \RC_n(S_{n+1})$, let $c$ be the code of the permutation $\wof{R}w_0(n + 1)$. Then we define
$$\mathrm{lift}_n(R) = A_1\otimes \cdots \otimes A_{\ell(c)}$$
where $|A_i| = i - c_{n + 2 - i}$ and $\hr(A_i) = i$ for all $i$, with $A_i$ all elementary symmetric full $i$-Grassmannian RC graphs. There is a unique such representation.

Define a linear homomorphism
$$\RC_n^\QY:\mathcal{T}_n\to \BRC_n$$
defined as follows. Suppose $\RC_n(T)=R$. Then we map $R\mapsto R_\QY$, where 
$$\wtt(R)=\wtt(R_\QY)$$
and
$$\code(\wof{R_\QY}) = \wtt(\QY(R))$$

Let $R$ be a quasi-yamanouchi RC graph. Define
$$\mathfrak{F}(R) = \sum_{\substack{A\in\RC_n(\wof{R})\\\QY(A)=R}} \RC_n^\QY(A)$$
Then we define a bilinear map $*$ by
$$\mathfrak{F}(A)* \mathfrak{F}(B) = \RC_n^\QY(\mathrm{lift}_n(\mathfrak{F}(A))\mathrm{lift}_n(\mathfrak{F}(B)))$$
\end{definition}

\begin{definition}
Define a QY-component of $\RC_n(w)$ to be a maximal subset of $\RC_n(w)$ consisting of RC graphs that have the same word. We define $QY(\mathbf{w})$ to be the unique QY-component of $\RC_n(w)$ such that the word of any element of $QY(\mathbf{w})$ is $\mathbf{w}$, if such a component exists.
\end{definition}
...
$$\mathfrak{F}(A)*\mathfrak{F}(B) = \sum_{R=\QY(R)} \mathfrak{F}(R)$$
where the sum is over all pairs $A'$, $B'$ such that 
$$\RC_n(\mathrm{lift}_n(A')\mathrm{lift}_n(B'))=R$$
\end{theorem}
...
\end{theorem}
\subsection{The forest quotient}


\begin{definition}
  Define a linear homomorphism
$$\RC_n^\forest:\mathcal{T}_n\to \BRC_n$$
...
Define the forest element $\mathbf{P}_a(n)\in \mathcal{T}_n$ for a weak composition $a$ of length $n$ by
...
\begin{definition}
Define $\phi_\forest:\BRC\to\BRC$ by sending $R$ to the unique RC graph $R_\forest$ such that
$$Q_\forest(\mathrm{word}(R)) = Q_\forest(\mathrm{word}(R_\forest))$$ 
$$\code(\wof{R_\forest}) = \code_\forest(R)$$
and
$$\wtt(R_\forest) = \wtt(R)$$
\end{definition}

\begin{proposition} \label{proposition:forestiso}
  The linear map $\phi_\forest:\mathrm{Schub}_n\to\mathrm{Forest}_n$ is an isomorphism of right $\Lambda_n$-modules. Specifically,
  $$\phi_\forest(\mathcal{S}_w(n)) = \sum_{a\in\mathrm{Comp}(n)} \gamma_w^a \mathscr{P}_a(n)$$
  where $\gamma_w^a$ are the coefficients such that
$$\sch_w(x) = \sum_{a\in\mathrm{Comp}(n)} \gamma_w^a \forest_a(x)$$
\end{proposition}
\begin{proof}
From \cite{nadeau2024forest}, the insertion algorithm ensures that $\RC_n(w)$ decomposes into a disjoint union of forest equivalence classes of reduced words and that each such equivalence class maps to a unique $\mathcal{P}_a(n)$ via $\RC_n^\forest$. Composing with the weight homomorphism to $\mathbb{Z}[x_1,\ldots,x_n]$ does not change the result, and since $\phi_\forest$ is surjective and injective, it is a linear isomorphism. Consider now $\Lambda_n$ as generated by elementary full-Grassmannian RC graphs, since most Schur polynomials are not forest polynomials. To prove that $\phi_\forest$ is a $\Lambda_n$-module isomorphism, we need only consider multiplication by a single elementary full $n$-Grassmannian RC graph. The action of such an RC graph on $\mathcal{S}_w(n)$ is given by the box product and the Pieri formula. We are ensured therefore that $\mathcal{S}_w(n)\boxtimes A\in \mathrm{Schub}_n$, from which it follows from \cite[Proposition~5.10]{nadeau2024forest} that the result contains precisely the correct forest polynomial terms, since the RC graphs form complete $\equiv_\forest$-classes of words, even after descending to the canonical forest polynomial representatives. That is,
$$\phi_\forest(\mathcal{S}_w(n)\boxtimes A) = \sum_{a} \gamma_w^a \mathscr{P}_{a}(n)\boxtimes A$$
and the result follows.
%and since the weight homomorphism $\mathrm{Schub}_n\to\mathbb{Z}[x_1,\ldots,x_n]$ is an isomorphism factoring through a surjective homomorphism onto the submodule $\mathrm{Forest}_n$, the $\mathscr{P}_a(n)$ are linearly independent. The result follows.
\end{proof}

\begin{theorem}
Let $a,b\in \mathrm{Comp}(n)$. Then
$$\RC_\forest(\mathbf{P}_a(n)\mathbf{P}_b(n)) = \sum_{c} \beta_{ab}^c \mathscr{P}_c(n)$$
where $\beta_{ab}^c$ are the multiplicative structure constants of forest polynomials.
\end{theorem}
\begin{proof}
Let $F_a^{w;n}$ be the transition coefficients such that
$$\forest_a(x) = \sum_{w} F_a^{w;n} \sch_w(x)$$
Notice that these may be negative. Define
$$\mathbf{P}'_a(n) = \sum_{w} F_a^{w;n} \mathbf{S}_w(n)$$
Then, by Theorem \ref{theorem:schubproduct}, we have that
$$\RC(\mathbf{P}'_a(n)\mathbf{P}'_b(n)) = \sum_{u,v} c_{u,v}^w F_a^{u;n} F_b^{v;n} \mathcal{S}_w(n)$$
Applying $\phi_\forest$ to both sides, we have that
$$\RC_\forest(\mathbf{P}'_a(n)\mathbf{P}'_b(n)) = \sum_{u,v} c_{u,v}^w F_a^{u;n} F_b^{v;n} \sum_{c} \gamma_w^c \mathscr{P}_c(n)$$
which is equal to
$$\sum_{c} \beta_{ab}^c \mathscr{P}_c(n)$$
We claim that
$$\RC_\forest(\mathbf{P}_a(n)\mathbf{P}_b(n)) = \RC_\forest(\mathbf{P}'_a(n)\mathbf{P}'_b(n))$$
Consider
$$\RC_n(\mathbf{P}'_a(n)) = \mathcal{P}_a(n) - (\mathcal{P}_a(n) - \sum_{w} F_a^{w;n} \mathcal{S}_w(n))$$
and
$$\RC_n(\mathbf{P}'_a(n)\mathbf{P}'_b(n)) = \RC_n(\mathbf{P}_a(n)\mathbf{P}_b(n)) - \RC_n((\mathbf{P}_a(n) - \sum_{w} F_a^{w;n} \mathbf{S}_w(n))\mathbf{P}'_b(n)) - \RC_n(\mathbf{P}_a(n)(\mathbf{P}_a(n) - \sum_{w} F_b^{w;n} \mathbf{S}_w(n)))$$
% Thus,
% $$
% \begin{aligned}
% \RC_\forest(\mathbf{P}_a(n)\mathbf{P}_b(n))
% &= \RC_\forest(\mathbf{P}'_a(n)\mathbf{P}'_b(n)) \\
% &\quad - \RC_\forest\!\left(\mathbf{P}_a(n)\left(\mathbf{P}_b(n) - \sum_{w} F_b^{w;n} \mathbf{S}_w(n)\right)\right) \\
% &\quad - \RC_\forest\!\left(\left(\mathbf{P}_a(n) - \sum_{w} F_a^{w;n} \mathbf{S}_w(n)\right)\mathbf{P}_b(n)\right) \\
% &\quad + \RC_\forest\!\left(\left(\mathbf{P}_a(n) - \sum_{w} F_a^{w;n} \mathbf{S}_w(n)\right)\left(\mathbf{P}_b(n) - \sum_{w} F_b^{w;n} \mathbf{S}_w(n)\right)\right)
% \end{aligned}
% $$
% which simplifies to
% $$
...
% \RC_\forest(\mathbf{P}_a(n)\mathbf{P}_b(n))
% &= \RC_\forest(\mathbf{P}'_a(n)\mathbf{P}'_b(n)) \\
% &\quad - \RC_\forest\!\left(\mathbf{P}_a(n)\mathbf{P}_b(n))
% &\quad - \RC_\forest\!\left(\mathbf{P}_a(n)\mathbf{P}_b'(n))
% &\quad - \RC_\forest\!\left(\left(\mathbf{P}_a(n) - \sum_{w} F_a^{w;n} \mathbf{S}_w(n)\right)\left(\mathbf{P}_b(n) - \sum_{w} F_b^{w;n} \mathbf{S}_w(n)\right)\right)
% \end{aligned}
% $$
...
% \begin{definition}
% Let $c$ be a composition. Define $\mathbf{F}_c(n)\in \mathcal{T}_n$ by
% $$\mathbf{F}_c(n) = \sum_{\substack{A\in\mathbf{E}_{\code^{-1}(c)}^{\alpha;n}\\\code_\forest(\RC(A)) = c}} A$$
% \end{definition}
\appendix
