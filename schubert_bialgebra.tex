...
%\begin{align*}
% &[0000] \otimes [0015] - [0000] \otimes [0033] - [0000] \otimes [0114] + [0000] \otimes [0123] \\
% &+ [0001] \otimes [0014] - [0001] \otimes [0032] - [0001] \otimes [0113] + [0001] \otimes [0122] \\
% &+ [0002] \otimes [0013] - [0002] \otimes [0031] - [0002] \otimes [0112] + [0002] \otimes [0121] \\
% &+ [0003] \otimes [0012] - [0003] \otimes [0030] - [0003] \otimes [0111] + [0003] \otimes [0120] \\
% &+ [0004] \otimes [0011] - [0004] \otimes [0110] + [0005] \otimes [0010] + [0010] \otimes [0005] \\
% &- [0010] \otimes [0023] - [0010] \otimes [0104] + [0010] \otimes [0113] + [0011] \otimes [0004] \\
% &- [0011] \otimes [0022] - [0011] \otimes [0103] + [0011] \otimes [0112] + [0012] \otimes [0003] \\
% &- [0012] \otimes [0021] - [0012] \otimes [0102] + [0012] \otimes [0111] + [0013] \otimes [0002] \\
% &- [0013] \otimes [0020] - [0013] \otimes [0101] + [0013] \otimes [0110] + [0014] \otimes [0001] \\
% &- [0014] \otimes [0100] + [0015] \otimes [0000] - [0020] \otimes [0013] + [0020] \otimes [0103] \\
% &- [0021] \otimes [0012] + [0021] \otimes [0102] - [0022] \otimes [0011] + [0022] \otimes [0101] \\
% &- [0023] \otimes [0010] + [0023] \otimes [0100] - [0030] \otimes [0003] - [0031] \otimes [0002] \\
% &- [0032] \otimes [0001] - [0033] \otimes [0000] - [0100] \otimes [0014] + [0100] \otimes [0023] \\
% &- [0101] \otimes [0013] + [0101] \otimes [0022] - [0102] \otimes [0012] + [0102] \otimes [0021] \\
% &- [0103] \otimes [0011] + [0103] \otimes [0020] - [0104] \otimes [0010] - [0110] \otimes [0004] \\
% &+ [0110] \otimes [0013] - [0111] \otimes [0003] + [0111] \otimes [0012] - [0112] \otimes [0002] \\
% &+ [0112] \otimes [0011] - [0113] \otimes [0001] + [0113] \otimes [0010] - [0114] \otimes [0000] \\
% &+ [0120] \otimes [0003] + [0121] \otimes [0002] + [0122] \otimes [0001] + [0123] \otimes [0000]
\begin{align*}
...
% \begin{align*}
% &1 \otimes \Xi_{1357246}^{4} + \Xi_{12354}^{4} \otimes \Xi_{1257346}^{4} + \Xi_{12354}^{4} \otimes \Xi_{1347256}^{4} \\
% &+ \Xi_{12354}^{4} \otimes \Xi_{135624}^{4} + \Xi_{123645}^{4} \otimes \Xi_{1247356}^{4} + \Xi_{123645}^{4} \otimes \Xi_{125634}^{4} \\
% &+ \Xi_{123645}^{4} \otimes \Xi_{1327456}^{4} + \Xi_{123645}^{4} \otimes \Xi_{134625}^{4} + \Xi_{123645}^{4} \otimes \Xi_{13542}^{4} \\
% &+ \Xi_{1237456}^{4} \otimes \Xi_{124635}^{4} + \Xi_{1237456}^{4} \otimes \Xi_{12543}^{4} + \Xi_{1237456}^{4} \otimes \Xi_{132645}^{4} \\
% &+ \Xi_{1237456}^{4} \otimes \Xi_{13524}^{4} + \Xi_{1243}^{4} \otimes \Xi_{1257346}^{4} + \Xi_{1243}^{4} \otimes \Xi_{1347256}^{4} \\
% &+ \Xi_{12453}^{4} \otimes \Xi_{1247356}^{4} + \Xi_{12453}^{4} \otimes \Xi_{125634}^{4} + \Xi_{12453}^{4} \otimes \Xi_{134625}^{4} \\
% &+ \Xi_{124635}^{4} \otimes \Xi_{1237456}^{4} + 2 \Xi_{124635}^{4} \otimes \Xi_{124635}^{4} + \Xi_{124635}^{4} \otimes \Xi_{12543}^{4} \\
% &+ \Xi_{124635}^{4} \otimes \Xi_{132645}^{4} + \Xi_{124635}^{4} \otimes \Xi_{13452}^{4} + \Xi_{1247356}^{4} \otimes \Xi_{123645}^{4} \\
% &+ \Xi_{1247356}^{4} \otimes \Xi_{12453}^{4} + \Xi_{1247356}^{4} \otimes \Xi_{12534}^{4} + \Xi_{1247356}^{4} \otimes \Xi_{13254}^{4} \\
% &+ \Xi_{1247356}^{4} \otimes \Xi_{1342}^{4} + \Xi_{12534}^{4} \otimes \Xi_{1247356}^{4} + \Xi_{12534}^{4} \otimes \Xi_{1327456}^{4} \\
% &+ \Xi_{12543}^{4} \otimes \Xi_{1237456}^{4} + \Xi_{12543}^{4} \otimes \Xi_{124635}^{4} + \Xi_{12543}^{4} \otimes \Xi_{132645}^{4} \\
% &+ \Xi_{125634}^{4} \otimes \Xi_{123645}^{4} + \Xi_{125634}^{4} \otimes \Xi_{12453}^{4} + \Xi_{125634}^{4} \otimes \Xi_{13254}^{4} \\
% &+ \Xi_{1257346}^{4} \otimes \Xi_{12354}^{4} + \Xi_{1257346}^{4} \otimes \Xi_{1243}^{4} + \Xi_{1257346}^{4} \otimes \Xi_{132}^{4} \\
% &+ \Xi_{132}^{4} \otimes \Xi_{1257346}^{4} + \Xi_{13254}^{4} \otimes \Xi_{1247356}^{4} + \Xi_{13254}^{4} \otimes \Xi_{125634}^{4} \\
% &+ \Xi_{132645}^{4} \otimes \Xi_{1237456}^{4} + \Xi_{132645}^{4} \otimes \Xi_{124635}^{4} + \Xi_{132645}^{4} \otimes \Xi_{12543}^{4} \\
% &+ \Xi_{1327456}^{4} \otimes \Xi_{123645}^{4} + \Xi_{1327456}^{4} \otimes \Xi_{12534}^{4} + \Xi_{1342}^{4} \otimes \Xi_{1247356}^{4} \\
% &+ \Xi_{13452}^{4} \otimes \Xi_{124635}^{4} + \Xi_{134625}^{4} \otimes \Xi_{123645}^{4} + \Xi_{134625}^{4} \otimes \Xi_{12453}^{4} \\
% &+ \Xi_{1347256}^{4} \otimes \Xi_{12354}^{4} + \Xi_{1347256}^{4} \otimes \Xi_{1243}^{4} + \Xi_{13524}^{4} \otimes \Xi_{1237456}^{4} \\
% &+ \Xi_{13542}^{4} \otimes \Xi_{123645}^{4} + \Xi_{135624}^{4} \otimes \Xi_{12354}^{4} + \Xi_{1357246}^{4} \otimes 1
%\end{align*}
\begin{align*}
...
%\sch_{124635}(x)\sch_{124635}(x) &= \mathfrak{S}_{12583467}{\left(x \right)} + \mathfrak{S}_{1267345}{\left(x \right)} + \mathfrak{S}_{13482567}{\left(x \right)} \\
%                                 & + 2 \mathfrak{S}_{1357246}{\left(x \right)} + \mathfrak{S}_{145623}{\left(x \right)} + \mathfrak{S}_{2347156}{\left(x \right)} \\
%                                 & + \mathfrak{S}_{235614}{\left(x \right)}
\begin{align*}
...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[blue, line width=2.5pt] (0.5,2) .. controls (0.5,2.3) and (0.7,2.5) .. (1,2.5);
  \draw[blue, line width=2.5pt] (1,2.5) .. controls (1.3,2.5) and (1.5,2.7) .. (1.5,3);
  \draw[blue, line width=2.5pt] (1.5,2) .. controls (1.5,2.3) and (1.7,2.5) .. (2,2.5);
  ...
  \draw[blue, line width=2.5pt] (0.5,1) .. controls (0.5,1.3) and (0.7,1.5) .. (1,1.5);
...
\begin{tikzpicture}[scale=1.5]
  ...
  \draw[blue, line width=2.5pt] (0.5,0) .. controls (0.5,0.3) and (0.7,0.5) .. (1,0.5);
  
  % Labels
  \node[font=\bfseries, text=blue] at (0.25,0.75) {$q$};
  \node[font=\bfseries, text=blue] at (0.75,0.25) {$s$};
...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[blue, line width=2.5pt, line cap=round] (4.5,5) -- (4.5,6);
  \draw[blue, line width=2.5pt] (5,5.5) .. controls (5.3,5.5) and (5.5,5.7) .. (5.5,6);
  \draw[blue, line width=2.5pt, line cap=round] (0,4.5) -- (1,4.5);
  \draw[blue, line width=2.5pt, line cap=round] (0.5,4) -- (0.5,5);
  \draw[blue, line width=2.5pt] (1,4.5) .. controls (1.3,4.5) and (1.5,4.7) .. (1.5,5);
...
\begin{tikzpicture}[scale=0.8]
  ...
  \draw[blue, line width=2.5pt] (0.5,3) .. controls (0.5,3.3) and (0.7,3.5) .. (1,3.5);
  \draw[blue, line width=2.5pt, line cap=round] (1,3.5) -- (2,3.5);
  \draw[blue, line width=2.5pt, line cap=round] (1.5,3) -- (1.5,4);
  \draw[blue, line width=2.5pt, line cap=round] (2,3.5) -- (3,3.5);
  \draw[blue, line width=2.5pt, line cap=round] (2.5,3) -- (2.5,4);
  \draw[blue, line width=2.5pt] (3,3.5) .. controls (3.3,3.5) and (3.5,3.7) .. (3.5,4);
  \draw[blue, line width=2.5pt] (0,2.5) .. controls (0.3,2.5) and (0.5,2.7) .. (0.5,3);
  ...
  \draw[blue, line width=2.5pt, line cap=round] (1.5,2) -- (1.5,3);
  \draw[blue, line width=2.5pt] (2,2.5) .. controls (2.3,2.5) and (2.5,2.7) .. (2.5,3);
  \draw[blue, line width=2.5pt] (0,1.5) .. controls (0.3,1.5) and (0.5,1.7) .. (0.5,2);
  \draw[blue, line width=2.5pt] (0.5,1) .. controls (0.5,1.3) and (0.7,1.5) .. (1,1.5);
  \draw[blue, line width=2.5pt] (1,1.5) .. controls (1.3,1.5) and (1.5,1.7) .. (1.5,2);
...
\begin{tikzpicture}[scale=0.8]
  ...
  \draw[blue, line width=2.5pt, line cap=round] (0.5,1) -- (0.5,2);
  \draw[blue, line width=2.5pt] (1,1.5) .. controls (1.3,1.5) and (1.5,1.7) .. (1.5,2);
...
\begin{tikzpicture}[scale=0.8]
  ...
  \draw[blue, line width=2.5pt, line cap=round] (0.5,2) -- (0.5,3);
  \draw[blue, line width=2.5pt] (1,2.5) .. controls (1.3,2.5) and (1.5,2.7) .. (1.5,3);
  \draw[blue, line width=2.5pt] (1.5,2) .. controls (1.5,2.3) and (1.7,2.5) .. (2,2.5);
  \draw[blue, line width=2.5pt] (2,2.5) .. controls (2.3,2.5) and (2.5,2.7) .. (2.5,3);
  \draw[blue, line width=2.5pt, line cap=round] (0,1.5) -- (1,1.5);
...
\begin{definition}
Let $(R,n)$ be a bounded RC graph and let $p$ be a descent of $\wof{R}$ such that row $p$ of $R$ is empty. Now, $\maxd(R_{\leq p})$ could be greater than $p$. If it is less than or equal to $p$, define $\zeromap^{(p)}(R,n) = (\zeromap(R_{\leq p})\cup {\downarrow R_{>p}},n-1)$. Otherwise, let $J$ be the set of all simple reflections in $S_\infty$ excluding all $d\in \mathcal{D}(w)$ such that $d\leq p$. Let $w^J$ be the minimal length coset representative of $wW_j$. Using the exchange property, we extract $w_J$ uniquely from $R$ to obtain an RC graph $R^J$ such that $\wof{R^J} = w^J$. We may define $\zeromap^{(p)}(R^J,n)$ as above, then insert the $w_J$ elements back in.
\end{definition}
...
Suppose we have two bounded RC graphs $(R_1, m)$ and $(R_2,n)$. The product of these is defined by
$$(R_1, m)\diamond (R_2, n) = \sum_{\clp^m(R')=R_1,\trm^m(R')=R_2}(R', m + n)$$  
\end{definition}
...
\end{lemma}
\begin{proof}
The first statement is equivalent to saying that if $m\leq n$, then
$$\clp^m(\clp^n(R))=\clp^m(R)$$
It suffices to prove this for $n=m+1$.
\end{proof}
...
\end{theorem}
\begin{proof}
What is in question is associativity. Suppose we are given three bounded RC graphs $(R_1, p)$, $(R_2, q)$, and $(R_3, r)$, and we want to show that the order of bracketing the product is irrelevant. This is because if $R_w$ is a term in the product, 
$$\clp^p(\clp^{p+q}(R_w)) = R_1 = \clp^p(R_w)$$
$$\trm^p(\clp^{p+q}(R_w)) = R_2 = \clp^q(\trm^p(R_w))$$ 
and 
$$\trm^{p+q}(R_w) = R_3 = \trm^q(\trm^{p}(R_w))$$
and each term in the product has a coefficient of $1$.

% Consider the set $A$ of pairs of permutations $(u,w)$ such that there exists an RC graph $R_u$ with $\clp^p(R_u) = R_1$, $\trm^q(R_u) = R_2$, as well as an RC graph $R_w$ such that $\clp^{p+q}(R_w)=R_u$ and $\trm^{p+q}(R_w) = R_3$. The bracketing in the first order yields the sum
% $$\sum_{(u,w)\in A}(R_w, p+q+r)$$
% Similarly, let $B$ be the set of permutations $(w, v)$ such that there exists an RC graph $R_v$ with $\clp^q(R_v) = R_2$, $\trm^r(R_v) = R_3$, as well as an RC graph $R_w$ such that $\clp^{p}(R_w)=R_1$ and $\trm^{p}(R_w) = R_v$. The bracketing in the second order yields the sum
% $$\sum_{(w,v)\in B}(R_w, p+q+r)$$
% Then we claim that $(u, w)\mapsto (w, \wof{\trm^p(R_w)})$ is a bijection between $A$ and $B$ that preserves the sum (since $w$ is the same). To construct the inverse, note that the pair $(R_2, R_3)$ together with $v=\wof{\trm^p(R_w)}$ determine a unique RC graph $R_v$ such that $\trm^q(R_v) = \trm^{p+q}(R_w) = R_3$. $R_3$ together with $\clp^{p+q}(R_w)$ and $w$ uniquely determine $R_w$, and the associated permutation of $\clp^{p+q}(R_w)$ is precisely $u$. This establishes associativity.
% there is at most one bounded RC graph $(R_1', p + q)$ for each $u\in S_\infty$ such that $\clp^p(R_1') = R_1$, $\trm^p(R_1') = R_2$, and $\wof{R_1'} = u$. Given this RC graph and a permutation $w$, there is at most one bounded RC graph $(R'', p + q + r)$ such that $\clp^{p+q}(R'') = (R_1')$, $\trm^{p+q}(R'') = (R_3, r)$, and $\wof{R''} = w$.

% Now we may slice $R''$ at $p$ to obtain $(R_1, p)$ and $\trm^p(R'')$, which together with $w$ uniquely determine $R''$. We also know that $\trm^q(\trm^p(R'')) = R_3$ and $\trm^q(\clp^{p+q}(R'')) = R_2$. Thus the unique choice of permutation $u'$ yielding the result for the opposite bracketing is $\wof{R''_{\leq p}}^{-1}w$. This establishes associativity.

$\omega:\BRC\to \dcoma$ is easily seen to be a homomorphism of rings, since the product is weight preserving in the correct way. For the map $\alpha:\BRC\to \dcoma$, we utilize the formula for the coefficient $d_{u,v}^w(p,q)$ as the coefficient of $\sch_u(x_1,\ldots,x_p)$ when we set $x_{p+1}=\cdots=x_{p+q}=0$ in the polynomial
$$\partial^{\shup^p v}\sch_w(x_1,\ldots,x_{p+q})$$
We claim that if we fix an RC graph $R_u$ for $u$ and an RC graph $R_v$ for $v$, then this coefficient is the same as the number of BRCs $(R, p+q)$ for $w$ such that $\trm^p(R)=R_v$ and $\clp^p(R) = R_u$. If we assume that $v$ is the identity, this follows from Theorem \ref{theorem:zero_bijection}. The divided difference operator characterization means that for $\ell(v)>0$, we can replace the empty space with any (shifted up) RC graph for $v$ $(R_v, q)$ and get the result as desired. 
\end{proof}
...
\end{tikzpicture}
\caption{The six possible tiles in bumpless pipe dreams. Pipes enter from the left or bottom and exit at the top or right.}
\label{figure:bpdtiles}
\end{figure}


\begin{lemma}[\cite{WEIGANDT2021105470}] \label{lemma:bpd_completion}
  Let $(B, N)$ be an ordinary reduced BPD for a permutation $w$, so that $w(M) = M$ for all $M>N$ and $B$ is $N\times N$. Let $n\geq \maxd(w)$ be an integer. Then the BPD $B'$ obtained by only retaining the first $n$ rows of $B$ satisfies $w(B', n) = w(B, N)$ and uniquely determines $B$.
\end{lemma}
...
\foreach \i in {1,...,6} {
  \node[below] at (\i*\s-0.5*\s,-0.3) {\i};
}

% Row exit labels on right
\node[right] at (6*\s+0.2,3.5*\s) {1};
\node[right] at (6*\s+0.2,2.5*\s) {3};
\node[right] at (6*\s+0.2,1.5*\s) {6};
\node[right] at (6*\s+0.2,0.5*\s) {4};

\end{tikzpicture}
\caption{An example of a $4$-row bumpless pipe dream for a permutation of length $6$. Pipes enter from the bottom at columns 1, 3, 4, and 6, and exit on the right at the labeled rows. The associated permutation is $[1,3,6,4,2,5]$.}
...
\end{tikzpicture}
\caption{The $\bzeromap$ transformation on a bumpless pipe dream with permutation $[1,6,2,3,7,4,5]$. The bottom row is removed, resulting in a BPD with one fewer row and permutation $[1,6,2,5,3,4]$.}
...
$$B\looparrowright C = \Delta(((a_1, r_1), (a_2, r_2), \ldots, (a_m, r_m)),C\shup^p)$$

We may define a ring product on $\BPD$, independently of the bijection, by declaring that 
$$(B, p)\diamond (C, q) = \sum_{\mathbf{t}^N(B', p + N) = (B,n)} (B'\looparrowright C, p+q)$$
\end{definition}
...
% To prove this, we will take an algebraic detour. \emph{Reduced factorizations} are essentially RC graphs where negative columns are allowed. We may define $\BRF$ similarily to $\BRC$, where an element of $\BRF$ is a pair $(R, n)$ where $R$ is a reduced factorization and $\maxd(\wof{R})\leq n$. An element $(R,n)$ in $\BRF$ generates a full Kashiwara crystal under the crystal operators defined previously, with the reflection operators satisfying
% $$\wtt(\cs_i(R, n)) = s_i\wtt((R,n))$$

%We extend the definition of $\rcdd^i$ to $\BRF$ by using the same definition if $(R,n)$ is an RC graph in rows $i$ and $i+1$. We extend the definition to $\BRF$ as follows. We declare that if $(R,n)$ is not an RC graph in rows $i$ and $i+1$, then $\rcdd^i(R,n)=0$ unless there is a $j$ (necessarily negative) such that $(i+1,j)\in R$ and $\rtt_R(i+1,j) = (i, i+1)$, In that case, define $R'=R\setminus\{(i+1,j)\}$. Then if $f_i(R')\neq \emptyset$, define $\rcdd^i(R,n)=0$. Otherwise, define
%$$\rcdd^i(R,n) = -\sum_{p=0}^{\varepsilon_i(R')}e_i^pR'$$

% We consider the module $\mathbb{Q}(x)\otimes\BRF$ now, and quotient by the $S_\infty$-invariant submodule $D$ generated by elements of the form
% $$(R,n) - \cs_i(R,n) - (x_{i} - x_{i+1})\otimes\rcdd^i(R,n),$$
% to obtain the module $\widetilde{\BRF}=(\mathbb{Z}[x]\otimes\BRF)/D$. $D$ is easily seen to be a submodule that is $S_\infty$-invariant. 

% \begin{lemma}
% The elements $(R,n)$ for $(R, n)\in \BRF$ remain distinct in the quotient $\widetilde{\BRF}$ of degree $\ell(\wof{R})$, forming a $\mathbb{Z}$-basis of a $\mathbb{Z}$-submodule of $\widetilde{\BRF}$ isomorphic to $\BRF$.
% \end{lemma}
% \begin{proof}
% This follows by the fact that $(R,n)$ and $\cs_i(R,n)$ are of the same degree as $R$, and $\rcdd^i(R,n)$ is of degree one less than that of $R$ with nonzero coefficient. Over $\mathbb{Z}$, no linear combinations of elements of these two forms can be equal unless they are zero, since $\mathbb{Z}[x]\otimes \BRF$ is free over $\mathbb{Z}[x]$ with basis the elements $(R,n)$.
% \end{proof}

% \begin{lemma}
% The submodule $D$ of $\mathbb{Z}[x]\otimes \BRF$ is $S_\infty$-invariant.
% \end{lemma}
% \begin{proof}
% The key fact that causes this to be true is that the basis element $(R,n)-\cs_i(R,n) - (x_i - x_{i+1})\otimes \rcdd^i(R,n)$ is mapped to a linear combination of similar basis elements under the action of any simple reflection $s_j$. This follows from the fact that the simple reflections and crystal operators satisfy the Coxeter relations, and that the divided difference operators satisfy the braid relations.
%  \end{proof}
%The module $\widetilde{BRF}$ is still graded by degree and has the elements $(R,n)$ as a basis of homogeneous elements.


% Let $\mathcal{N}$ be the nil-Hecke ring over $\mathbb{Q}(x)$. We define an action of $\mathcal{N}$ on $\BRF_{\mathbb{Q}(x)}$ by declaring that
% $$\partial^ip(x)(R,n) = (\partial^ip(x))(R, n)+(s_ip(x))\frac{1}{x_i - x_{i+1}}((R,n) - \cs_i(R, n))$$


% \begin{lemma}
% The action of the nil-Hecke ring $\mathcal{N}$ on $\BRF_{\mathbb{Q}(x)}$ defined above is well-defined and intertwines with the homomorphism of $\BRF_{\mathbb{Q}(x)}$ into $\mathbb{Q}(x)$.
% \end{lemma}

% \begin{lemma}
% Suppose $(R,n) \in \BRC$. Then $\rcdd^i(R,n)=0$ if and only if $\cs_i(R,n) = (R,n)$.
% \end{lemma}

% Define a homomorphism $P:\BRF_{\mathbb{Q}(x)}\to \BRC_{\mathbb{Q}(x)}$ by declaring that $P(R,n) = (R,n)$ if $(R,n)$ is an RC graph, and $P(R,n)=0$ otherwise.

% \begin{proposition}
% For any RC graph $(R,n)\in \BRF$, we have 
% $$P(\partial^i(R,n)) = \rcdd^iP(R,n)$$
% \end{proposition}

% The first equation is immediate, and the second follows from the fact that the simple reflections and crystal operators satisfy this condition. 

% For the third condition, we make use of Lemma \ref{lemma:block_structure}. Assume that the LHS is nonzero. Then by Lemma \ref{lemma:block_structure}, rows $i$ and $i+1$ must have the configuration in Figure \ref{figure:divdiff_braid_lhs}. When applying $\rcdd^i$, we start by deleting $(i,j)$, then propogate down the $i$-string of the resulting RC graph. In the case that in row $i+2$ we have that $(i+2, j')\in R$ for all $j'<j-1$, and $(i+2, j-1)\notin R$ as well, the deletion sequence is clear. 

% If $(i+2, j-1)\in R$, the situation is more complex. Since there is no ``ledge'' initially in row $i+1$ after deleting $(i,j)$, in order for $\rcdd^{i+1}$ application to be nonzero there must be some boxes in row $i$ starting at column $j+1$ (and possibly extending further). We could consider the possibility that the the box that moves from $(i, j+1)$ to $(i+1,j)$ is the root $(i+1, i+2)$ in row $i+1$ that we are deleting (which happens if and only if row $i+2$ has no space before column $j$). After this deletion, however, we are stuck: there is no root in row $i$ to delete. It follows that if $(i+2, j-1)\in R$ and the LHS is nonzero, there is a $p<j-1$ such that $(i+2, p)\notin R$. In that case, assuming $p$ is minimal, we have that $(i+1,p)$ is the root to delete. After deleting this root, we apply lowering operators to row $i+1$, moving a portion of the row to row $i+2$, clearing a space for a ledge for the $(i,i+1)$ root, which occurs precisely at $(i, p)$. 
...
%there is a single term, which is easily seen to be equal to both sides. Therefore, consider the case that at column $c<j-1$, with $c$ minimal, we have an empty space at $(i+2,c)$. When $(i,j)$ is deleted from $R$, we then apply lowering operators to row $i$ as much as we can to obtain all of the terms in the sum.  No application of any power of $f_i$ will change the elements of $R$ in row $i+1$ before column $j$. Since by assumption some term has $\rcdd^{i+1}$ nonzero, we must have had that $\rtt_R(i+1,c) = (i+1,i+2)$ by Lemma \ref{lemma:block_structure}. The same argument fixes the position of $(i, i+1)$ at $(i, c)$ after application of $\rcdd^{i+1}\rcdd^i$.
...
%   \begin{scope}[shift={(0,0)}]
%     \node[above] at (3.5,4.5) {\textbf{Initial: $R$}};
    
%     % Row i - boxes from left up to and including position before j, then (i,j) filled
%     \fill[blue!30] (0,3) rectangle (1,4);
%     \draw (0,3) rectangle (1,4);
%     \node at (1.5,3.5) {$\cdots$};
%     \fill[blue!30] (1.8,3) rectangle (2,4);
%     \draw (1.8,3) rectangle (2,4);
%     \fill[blue!30] (2,3) rectangle (3,4);
%     \draw (2,3) rectangle (3,4);
%     \fill[blue!30] (3,3) rectangle (4,4);
%     \draw (3,3) rectangle (4,4);
%     \node at (3.5,3.5) {$\cdots$};
%     \fill[blue!30] (4,3) rectangle (5,4);
%     \draw (4,3) rectangle (5,4);
%     \fill[green!40] (5,3) rectangle (6,4);
%     \draw[thick] (5,3) rectangle (6,4);
%     \node at (5.5,3.5) {$\bullet$};
%     \draw[dashed] (6,3) rectangle (7,4);
    
%     % Row i+1 - boxes up to p-1, then target at p, then boxes from p+1 to j-1, empty at j
%     \fill[blue!30] (0,2) rectangle (1,3);
%     \draw (0,2) rectangle (1,3);
%     \node at (1.5,2.5) {$\cdots$};
%     \fill[blue!30] (1.8,2) rectangle (2,3);
%     \draw (1.8,2) rectangle (2,3);
%     \fill[blue!30] (2,2) rectangle (3,3);
%     \draw (2,2) rectangle (3,3);
%     \fill[blue!30] (3,2) rectangle (4,3);
%     \draw (3,2) rectangle (4,3);
...
%     \fill[blue!30] (4,2) rectangle (5,3);
%     \draw (4,2) rectangle (5,3);
%     \draw[thick] (5,2) rectangle (6,3);
%     \node at (5.5,2.5) {$\circ$};
%     \draw[dashed] (6,2) rectangle (7,3);
    
%     % Row i+2 - boxes up to just before p
%     \fill[blue!30] (0,1) rectangle (1,2);
%     \draw (0,1) rectangle (1,2);
%     \node at (1.5,1.5) {$\cdots$};
%     \fill[blue!30] (1.8,1) rectangle (2,2);
%     \draw (1.8,1) rectangle (2,2);
%     \draw[thick] (2,1) rectangle (3,2);
%     \node at (2.5,1.5) {$\circ$};
%     \draw[dashed] (3,1) rectangle (4,2);
%     \draw[dashed] (4,1) rectangle (5,2);
%     \draw[dashed] (5,1) rectangle (6,2);
%     \draw[dashed] (6,1) rectangle (7,2);
    
%     \node[left] at (0,3.5) {$i$};
%     \node[left] at (0,2.5) {$i+1$};
%     \node[left] at (0,1.5) {$i+2$};
%     \node[below] at (2.5,0.8) {$p$};
%     \node[below] at (5.5,0.8) {$j$};
%   \end{scope}
  
%   % Arrow
%   \draw[->,thick] (7.5,2.5) -- (8.5,2.5) node[midway,above] {$\rcdd^i$};
  
%   % Panel 2: After rcdd^i (delete (i,j) and apply f_i)
%   \begin{scope}[shift={(9,0)}]
%     \node[above] at (3.5,4.5) {\textbf{After $\rcdd^i$}};
    
%     % Row i - lowering operators have moved things, creating a ledge at position p
%     \fill[blue!30] (0,3) rectangle (1,4);
%     \draw (0,3) rectangle (1,4);
%     \node at (1.5,3.5) {$\cdots$};
%     \fill[blue!30] (1.8,3) rectangle (2,4);
...
%     % Row i+1 - unchanged before j, target at p is important
%     \fill[blue!30] (0,2) rectangle (1,3);
%     \draw (0,2) rectangle (1,3);
%     \node at (1.5,2.5) {$\cdots$};
%     \fill[blue!30] (1.8,2) rectangle (2,3);
%     \draw (1.8,2) rectangle (2,3);
%     \fill[yellow!40] (2,2) rectangle (3,3);
%     \draw (2,2) rectangle (3,3);
...
%     \node[anchor=north,align=center,text width=4cm] at (3.5,0) {\tiny $\rtt(i+1,p)=(i+1,i+2)$};
%   \end{scope}
  
%   % Arrow
%   \draw[->,thick] (16.5,2.5) -- (17.5,2.5) node[midway,above] {$\rcdd^{i+1}$};
  
%   % Panel 3: After rcdd^{i+1}rcdd^i
%   \begin{scope}[shift={(18,0)}]
%     \node[above] at (3.5,4.5) {\textbf{After $\rcdd^{i+1}\rcdd^i$}};
    
%     % Row i - position at (i,p) has the (i,i+1) root
%     \fill[blue!30] (0,3) rectangle (1,4);
%     \draw (0,3) rectangle (1,4);
%     \node at (1.5,3.5) {$\cdots$};
%     \fill[blue!30] (1.8,3) rectangle (2,4);
%     \draw (1.8,3) rectangle (2,4);
%     \fill[orange!40] (2,3) rectangle (3,4);
%     \draw[very thick] (2,3) rectangle (3,4);
%     \node at (2.5,3.5) {$\diamondsuit$};
%     \fill[blue!30] (3,3) rectangle (4,4);
%     \draw (3,3) rectangle (4,4);
%     \node at (3.5,3.5) {$\cdots$};
%     \fill[blue!30] (4,3) rectangle (5,4);
...
%     % Row i+1 - the target at p has been deleted, creating a ledge
%     \fill[blue!30] (0,2) rectangle (1,3);
%     \draw (0,2) rectangle (1,3);
%     \node at (1.5,2.5) {$\cdots$};
%     \fill[blue!30] (1.8,2) rectangle (2,3);
...
%     \node[anchor=north,align=center,text width=4cm] at (3.5,0) {\tiny $(i,i+1)$ at $(i,p)$};
%   \end{scope}
% \end{tikzpicture}
% \caption{Visualization of the braid relation argument. Starting from configuration with $(i,j)$ filled (green $\bullet$) and minimal empty column $p<j-1$ in row $i+2$ (marked $\star$ at $(i+1,p)$). Row $i$ and row $i+1$ have boxes between columns $p$ and $j$. After $\rcdd^i$: $(i,j)$ is deleted, a ledge is created at $(i,p)$ (orange $\diamondsuit$).}
% \label{figure:braid_relation_flow}
% \end{figure}

% Consider now assuming that the RHS is nonzero and applying $\rcdd^{i+1}$ first, then $\rcdd^i$. As before, we know there is a ledge in row $i+1$ at $(i+1,p)$ for some $c$. Deleting this box then should make an $(i, i+1)$ root available. Since row $i+1$ is full to the left of column $p$, the $(i,i+1)$ must occur at $(i, p)$. Now, without applying lowering operators, there is no ledge in row $i+1$, since the box at $(i+1, p)$ was deleted, the box at $(i+2,p)$ was not initially present, and both rows are full to the left of column $p$. A ledge much therefore have been created by lowering operators weakly to the right of column $p$. 

% \begin{figure}[h]
% \centering
% \begin{tikzpicture}[scale=0.7]
%   % TOP LEFT: Panel 1 - Initial configuration (RHS nonzero)
%   \begin{scope}[shift={(0,5)}]
%     \node[above] at (2,4.5) {\textbf{(1) Initial}};
...
%   % TOP RIGHT: Panel 2 - After first rcdd^{i+1}, now delete (i,c)
%   \begin{scope}[shift={(6,5)}]
%     \node[above] at (2.5,4.5) {\textbf{(2) Apply $\rcdd^{i}$}};
    
%     % Row i - we now know (i,c+1) is nonempty
%     \fill[blue!30] (0,3) rectangle (1,4);
%     \draw (0,3) rectangle (1,4);
%     \node at (1.5,3.5) {$\cdots$};
%     \fill[blue!30] (1.8,3) rectangle (2,4);
...
%     \draw[dashed] (4,3) rectangle (5,4);
    
%     % Row i+1 - (i+1,c) is now deleted
%     \fill[blue!30] (0,2) rectangle (1,3);
%     \draw (0,2) rectangle (1,3);
%     \node at (1.5,2.5) {$\cdots$};
%     \fill[blue!30] (1.8,2) rectangle (2,3);
...
%     \node[left] at (0,1.5) {$i+2$};
%     \node[below] at (2.5,0.8) {$c$};
%     \node[below] at (3.5,0.8) {$c+1$};
%   \end{scope}
  
%   % BOTTOM LEFT: Panel 3 - After rcdd^i, showing green tile and filled box beneath it
%   \begin{scope}[shift={(0,0)}]
%     \node[above] at (3,4.5) {\textbf{(3) After $\rcdd^{i}\rcdd^{i+1}$}};
    
%     % Row i - (i,c+1) deleted, green tile still visible
%     \fill[blue!30] (0,3) rectangle (1,4);
%     \draw (0,3) rectangle (1,4);
%     \node at (1.5,3.5) {$\cdots$};
%     \fill[blue!30] (1.8,3) rectangle (2,4);
...
%     \node at (3.5,3.5) {$\bullet$};
%     \draw[dashed] (4,3) rectangle (5,4);
%     \draw[dashed] (5,3) rectangle (6,4);
    
%     % Row i+1 - filled box beneath green tile
%     \fill[blue!30] (0,2) rectangle (1,3);
%     \draw (0,2) rectangle (1,3);
%     \node at (1.5,2.5) {$\cdots$};
%     \fill[blue!30] (1.8,2) rectangle (2,3);
...
%     \draw[dashed] (4,2) rectangle (5,3);
%     \draw[dashed] (5,2) rectangle (6,3);
    
%     % Arrow showing column c+1 moving down as a block
%     \draw[->,very thick,red] (3.5,2.8) -- (3.5,2.2);
    
%     % Row i+2 - where deletion will happen
%     \fill[blue!30] (0,1) rectangle (1,2);
%     \draw (0,1) rectangle (1,2);
%     \node at (1.5,1.5) {$\cdots$};
%     \fill[blue!30] (1.8,1) rectangle (2,2);
...
%   % Legend at bottom
%   \node[anchor=north,align=left] at (4,-1.5) {\small $\diamondsuit$: $\rtt(i,c)=(i,i+1)$ root; $\star$: target at $(i+1,c)$; $\bullet$: $(i+1,i+2)$ root moving};
% \end{tikzpicture}
% \caption{Reverse direction of the braid relation: applying $\rcdd^{i+1}\rcdd^{i}\rcdd^{i+1}$ (RHS). (1) Initially $\star$ marks $(i+1,c)$ to delete (purple). (2) After $\rcdd^{i+1}$, $(i,c)$ has $(i,i+1)$ root and $(i,c+1)$ is nonempty (green $\bullet$). (3) After $\rcdd^{i}$ deletes $(i,c+1)$, the green tile remains while the $(i+1,i+2)$ root moves southwest (arrow) from $(i+1,c+1)$ to its final position, where it will be deleted by the final $\rcdd^{i+1}$.}
% \label{figure:braid_relation_rhs}
% \end{figure}

% %By Proposition \ref{proposition:divdiffprincipal}, these identities hold when applied to any principal RC graph. Since only the exchange property and lowering operators are used in the definition, the opertors do indeed satisfy the Edelman-Greene relations.
% \end{proof}
...
% where there exists a weight-preserving isomorphism of crystal graphs $\mathscr{C}(R,n)\to C$.
% \end{corollary}
...
% \subsection{Hom from tensor dual}

% We define a homomorphism of rings into $H:\dcoma\to\BRC$ in the word basis by
% $$H(\alpha) = \sum_{\substack{\wtt(R)=\alpha\\\wof{R}=w}} (R,|\alpha|) R$$
